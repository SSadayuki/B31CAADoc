#ifndef CATInterproxCrv_H
#define CATInterproxCrv_H
 ...
 * <ul><li>Create it with the <tt>CATCreateInterproxCrv</tt> global method. The run is automatically done and the
 ...
 * <ul><li>Create it with the <tt>CATCreateInterproxCrv</tt> global method.
 ...
 * </ul>
 */
class ExportedByFrFOpeCrv CATInterproxCrv : public CATCGMVirtual
{
  CATCGMVirtualDeclareClass(CATInterproxCrv);
  public :

    virtual ~CATInterproxCrv();
/**
