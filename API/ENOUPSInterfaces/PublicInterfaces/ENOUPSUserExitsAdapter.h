...
//     
//===================================================================
#ifndef ENOUPSUserExitsAdapter_H
#define ENOUPSUserExitsAdapter_H
...
class ExportedByENOUPSInterfaces ENOUPSUserExitsAdapter : public ENOIUPSUserExitsBase
{
public :
    ...
    * Constructor
    */
    ENOUPSUserExitsAdapter();

    /**
    * Destructor
    */
    virtual ~ENOUPSUserExitsAdapter();
