...
#ifndef CATIAManufacturingProcess_h
#define CATIAManufacturingProcess_h
...
extern ExportedByManufacturingPubIdl IID IID_CATIAManufacturingProcess;

class ExportedByManufacturingPubIdl CATIAManufacturingProcess : public CATIABase
{
    CATDeclareInterface;

public:

    virtual HRESULT __stdcall get_Setups(CATIAMfgActivities *& oSetupsList)=0;


};

CATDeclareHandler(CATIAManufacturingProcess, CATIABase);
