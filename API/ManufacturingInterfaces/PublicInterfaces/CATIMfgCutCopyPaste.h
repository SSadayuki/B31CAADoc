#ifndef CATIMfgCutCopyPaste_H
#define CATIMfgCutCopyPaste_H
...
extern IID ExportedByMfgItfEnv IID_CATIMfgCutCopyPaste;
#else
extern "C" const IID IID_CATIMfgCutCopyPaste;
#endif

/**   
 * Interface dedicated to manage Cut, Copy and Paste.
 * <b>Role</b>: This interface offers services to customize the cut, copy and paste mechanisms.<br>
 * To define specific behaviours to your manufacturing object during the Cut/Copy/Paste, derive from
 * the supplied ObjectCCP_SPEC adapter class and called in the implementation of each method of CATICutAndPastable
 * the corresponding method of this interface. Thus, you retrieve the default mechanism provided by the
 * manufacturing infrastructure.
 */
class ExportedByMfgItfEnv CATIMfgCutCopyPaste : public CATBaseUnknown
{
    CATDeclareInterface;
...
CATDeclareHandler(CATIMfgCutCopyPaste, CATBaseUnknown);
