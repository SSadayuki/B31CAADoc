...
class ExportedByJS0CORBA CATBaseUnknown : public IDispatch
{
	...
	public:
		 ...
		 *   </dl>
		 */
		virtual HRESULT __stdcall QueryInterface(const IID &iIID,
		                                         void **oPPV);
		/**
		...
		/**
		 * @nodoc
		 * Set a pointer to the object that implements the given interface.
		 * @param iObject
		 *   The pointer on an implementation object.
		 */
		virtual CATBaseUnknown * __stdcall SetImpl(CATBaseUnknown *iObject);
		 ...
		 * It must be owerwritten to free pointers to others components. 
	...
	private:
		...
		friend ExportedByJS0CORBA IUnknown *Tie_Link(
										...
										CATBaseUnknown *,
										const GUID &);
		// to link an object on an implementation, internal use
		friend void LinkOnImpl(
										CATBaseUnknown *, 
										IUnknown *,
										CATMetaClass *, 
										const GUID &,
		...
		friend ExportedByJS0CORBA IUnknown *ToCreateBOA(
										CATBaseUnknown *,
										CATBaseUnknown *,
										CATMetaClass *, const GUID &,
										CATBaseUnknown *(*)());
		// to call methods from the TIE, internal use
		friend class Tie_StackCtx;
 ...
 * @nodoc
 */
#define CATNOVTABLE __declspec(novtable)
