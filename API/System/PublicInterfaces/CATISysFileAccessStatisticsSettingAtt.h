...
//===========================================================================
//  Creation novembre  2007                                 siu         	
//===========================================================================
# ifndef _CATISYSFILEACCESSSTATISTISSETTINGSATT
# define _CATISYSFILEACCESSSTATISTISSETTINGSATT
...
extern ExportedByJS03TRA IID IID_CATISysFileAccessStatisticsSettingAtt;
#else
extern "C" const IID IID_CATISysFileAccessStatisticsSettingAtt;
#endif


/**
* Interface to handle the parameters of the FileAccess statistic.
* <b>Role</b>: This interface is implemented by a component which
* represents the controller of the FileAccess statistic. 
...
*/
class ExportedByJS03TRA CATISysFileAccessStatisticsSettingAtt : public CATISysGeneralStatisticsSettingAtt
{
  CATDeclareInterface;
...
# endif /* _CATISYSFILEACCESSSTATISTISSETTINGSATT */
