...
//===========================================================================
# ifndef _CATISYSCOMMANDSTATISTISSETTINGSATT
# define _CATISYSCOMMANDSTATISTISSETTINGSATT
...
extern ExportedByJS03TRA IID IID_CATISysCommandStatisticsSettingAtt;
#else
extern "C" const IID IID_CATISysCommandStatisticsSettingAtt;
#endif


/**
* Interface to handle the parameters of the command statistic.
* <b>Role</b>: This interface is implemented by a component which
* represents the controller of the command statistic. 
...
*/
class ExportedByJS03TRA CATISysCommandStatisticsSettingAtt : public CATISysGeneralStatisticsSettingAtt
{
  CATDeclareInterface;
...
# endif /* _CATISYSCOMMANDSTATISTISSETTINGSATT */
