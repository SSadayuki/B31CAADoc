 ...
 * @CAA2Usage U3
 */
#ifndef CATIIniSearchJapaneseNameCriterion_H
#define CATIIniSearchJapaneseNameCriterion_H
...
extern ExportedByCATInteractiveInterfaces IID IID_CATIIniSearchJapaneseNameCriterion;
 ...
 */
class ExportedByCATInteractiveInterfaces CATIIniSearchJapaneseNameCriterion : public CATIIniSearchCriterion
{
  CATDeclareInterface;
