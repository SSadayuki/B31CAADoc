...
extern ExportedByCATInteractiveInterfaces IID IID_CATIIniSearchRealCriterion;
 ...
 */
class ExportedByCATInteractiveInterfaces CATIIniSearchRealCriterion : public CATIIniSearchCriterion
{
  CATDeclareInterface;
