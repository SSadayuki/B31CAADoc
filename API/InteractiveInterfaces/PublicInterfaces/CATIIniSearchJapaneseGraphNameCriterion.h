 ...
 * @CAA2Usage U3
 */
#ifndef CATIIniSearchJapaneseGraphNameCriterion_H
#define CATIIniSearchJapaneseGraphNameCriterion_H
...
extern ExportedByCATInteractiveInterfaces IID IID_CATIIniSearchJapaneseGraphNameCriterion;
 ...
 */
class ExportedByCATInteractiveInterfaces CATIIniSearchJapaneseGraphNameCriterion : public CATIIniSearchCriterion
{
  CATDeclareInterface;
