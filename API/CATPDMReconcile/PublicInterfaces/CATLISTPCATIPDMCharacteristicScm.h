#ifndef CATLISTPCATIPDMCharacteristicScm_H
#define CATLISTPCATIPDMCharacteristicScm_H
// Reconciliator
// Version 1 Release 0
...
/**
  * @collection CATLISTP(CATIPDMCharacteristicScm)
  * Collection class for pointers to <tt>CATIPDMCharacteristicScm</tt>.
...
// --- Declare the CATLISTP(CATIPDMCharacteristicScm) type.

#include "CATIPDMCharacteristicScm.h"

CATLISTP_DECLARE( CATIPDMCharacteristicScm )
