#ifndef CATECloPartSelectionAdapter_H
#define CATECloPartSelectionAdapter_H
 ...
 */
class ExportedByCATCommonLayoutItfCPP CATECloPartSelectionAdapter: public CATBaseUnknown
{
  public:
  ...
  // -------------------------------------
     ...
     virtual ~CATECloPartSelectionAdapter ();
  ...
  */
  virtual HRESULT FilterPartSelection (  
    ...
    */
    ...
    private:
    // do not implement
    CATECloPartSelectionAdapter (CATECloPartSelectionAdapter &);
    CATECloPartSelectionAdapter& operator=(CATECloPartSelectionAdapter&);
