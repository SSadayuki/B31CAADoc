...
#ifndef CATIAPartComp_h
#define CATIAPartComp_h
...
extern ExportedBySMTInterfacesPubIDL IID IID_CATIAPartComp;

class ExportedBySMTInterfacesPubIDL CATIAPartComp : public CATIABase
{
    CATDeclareInterface;
...
CATDeclareHandler(CATIAPartComp, CATIABase);
