#ifndef CATCGMCreateTopEuclidianDistanceTool_h_
#define CATCGMCreateTopEuclidianDistanceTool_h_
...
ExportedByCATGMOperatorsInterfaces CATICGMDistanceTool *CATCGMCreateTopEuclidianDistanceTool(
...
#endif /* CATCGMCreateTopEuclidianDistanceTool_h_ */
