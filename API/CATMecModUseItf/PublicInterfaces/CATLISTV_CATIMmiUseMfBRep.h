...
#ifndef CATLISTV_CATIMmiUseMfBRep_H
#define CATLISTV_CATIMmiUseMfBRep_H 
...
/**
 * @collection CATLISTV(CATIMmiUseMfBRep_var)
...
CATLISTHand_DECLARE(CATIMmiUseMfBRep_var)

#endif // CATLISTV_CATIMmiUseMfBRep_H
