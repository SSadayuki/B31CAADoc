/* -*-c++-*- */
#ifndef CATIGSMLoft_H
#define CATIGSMLoft_H
...
extern ExportedByCATGitInterfaces IID  IID_CATIGSMLoft;
#else
extern "C" const IID IID_CATIGSMLoft;
#endif
...
class ExportedByCATGitInterfaces CATIGSMLoft : public CATBaseUnknown
{
   CATDeclareInterface;
  ...
  , const CATISpecObject_var iNewSection
      ...
      */
      virtual HRESULT ModifySectionOrient(const CATISpecObject_var iSection
  , CATGSMOrientation iOrient = CATGSMSameOrientation
  ) = 0;
  
     /**
	  * @deprecated V6R2013x CATIGSMLoft#SetSectionSupport
      ...
      *   @param iTangentSection
      *      tangent surface to be added, the curve must be layed on the surface.
      */
      virtual HRESULT SetSectionTangent(const CATISpecObject_var iSection
  , const CATISpecObject_var iTangentSection
  ) = 0;

     /**
	  * @deprecated V6R2013x CATIGSMLoft#RemoveSectionSupport
      ...
      */
      virtual HRESULT RemoveSectionTangent(const CATISpecObject_var iSection
  ) = 0;
      ...
      */
      virtual HRESULT SetCompSectionTangent(const CATISpecObject_var iSection
      ...
      *      point to be added
      */
      virtual HRESULT SetSectionPoint(const CATISpecObject_var iSection
  , const CATISpecObject_var iPointSection
  ) = 0;   
      ...
      */
      virtual HRESULT RemoveSectionPoint(const CATISpecObject_var iSection
  ) = 0;
  
     /**
	  * @deprecated V6R2013x CATIGSMLoft#GetAllSectionsAndSupports
  ...
  , CATISpecObject_var & oStartSectionSupport
  , CATISpecObject_var & oEndSectionSupport
  )= 0;
      ...
      *      support surface at end section.
      */
      virtual HRESULT GetAllSectionsAndSupports( CATLISTV(CATISpecObject_var) & oSections
  , CATListOfInt & oOrientation
  , CATLISTV(CATISpecObject_var) & oPoint
  , CATISpecObject_var & oStartSectionSupport
  ...
  , const CATISpecObject_var iSpine = NULL_var
      ...
      */
      virtual HRESULT GetSpine( int & oSpineType, CATISpecObject_var & oSpine
  ) = 0;
  ...
  ,  const CATISpecObject_var iNewGuide
     ...
     /**
	  * @deprecated V6R2013x CATIGSMLoft#SetGuideSupport
      ...
      *      tangent surface to be added, the curve must be layed on the surface.
      */
      virtual HRESULT SetGuideTangent(const CATISpecObject_var iGuide
  , const CATISpecObject_var iTangentGuide
  ) = 0; 
  
     /**
	  * @deprecated V6R2013x CATIGSMLoft#RemoveGuideSupport
      ...
      */
      virtual HRESULT RemoveGuideTangent(const CATISpecObject_var iGuide
  ) = 0;
     ...
     /**
	  * @deprecated V6R2013x CATIGSMLoft#GetAllGuidesAndSupports
      * Gets informations about the guides of the lofted surface.
      *   @param oGuides
      *      list of the guides curves.
      ...
      */
      virtual HRESULT GetAllGuides( CATLISTV(CATISpecObject_var) & oGuides
 , CATLISTV(CATISpecObject_var) & oGuideSupports
  ) = 0;
	  ...
	  *	
      */
      virtual HRESULT GetAllGuidesAndSupports( CATLISTV(CATISpecObject_var) & oGuides
 , CATLISTV(CATISpecObject_var) & oGuideSupports
 , CATListOfInt & oContinuities) = 0;
   ...
   virtual HRESULT SetSectionCoupling( const CATGSMCouplingType iCoupling = CATGSMRatioCoupling
      ...
      */
      virtual HRESULT GetFacesForClosing(CATISpecObject_var & oStartFace
         , CATISpecObject_var & oEndFace
         ) = 0;
      ...
      *      End face used to close the loft.      
      */
      virtual HRESULT SetFaceForClosing(const CATISpecObject_var iSection
         , const CATISpecObject_var iFace
         ) = 0;
      ...
      *       section curve.
      */
      virtual HRESULT RemoveFaceForClosing(const CATISpecObject_var iSection
         ) = 0;
   ...
   */
   virtual HRESULT SetSectionSupport(const CATISpecObject_var &iSection,
	   const CATISpecObject_var &iSupportSection,
   ...
   *      Continuity between the support and the loft (accepted values are CATGSMContinuity_Tangency or CATGSMContinuity_Curvature).
   */
   virtual HRESULT RemoveSectionSupport(const CATISpecObject_var &iSection) = 0;
   ...
   *      Continuity between the support and the loft (accepted values are CATGSMContinuity_Tangency or CATGSMContinuity_Curvature).
   */
   virtual HRESULT SetGuideSupport(const CATISpecObject_var &iGuide,
	   const CATISpecObject_var &iSupportGuide,
	   const enum CATGSMContinuity &iContinuity) = 0;  
   ...
   *      Continuity between the support and the loft (accepted values are CATGSMContinuity_Tangency or CATGSMContinuity_Curvature).
   */
   virtual HRESULT RemoveGuideSupport(const CATISpecObject_var &iGuide) = 0;
};

CATDeclareHandler (CATIGSMLoft, CATBaseUnknown);
#endif // CATIGSMLoft_H
