/* -*-c++-*- */
#ifndef CATIGSMCircleTritangent_H
#define CATIGSMCircleTritangent_H
// 
...
extern ExportedByCATGitInterfaces IID  IID_CATIGSMCircleTritangent;
#else
extern "C" const IID IID_CATIGSMCircleTritangent;
#endif
/**
 ...
 */
class ExportedByCATGitInterfaces CATIGSMCircleTritangent : public CATBaseUnknown
{
   CATDeclareInterface;
public: 
  ...
  */
 virtual HRESULT GetSecondCurve(CATISpecObject_var& oSecondElem) = 0;
  ...
  *       second element : a curve or a point
  */
 virtual HRESULT SetSecondCurve(const CATISpecObject_var iSecondElem) = 0;
  ...
  */
 virtual HRESULT GetThirdCurve(CATISpecObject_var& oThirdElem) = 0;
  ...
  *       third element : a curve or a point
  */
 virtual HRESULT SetThirdCurve(const CATISpecObject_var iThirdElem) = 0;
...
CATDeclareHandler (CATIGSMCircleTritangent, CATBaseUnknown);
#endif
