/* -*-c++-*- */
#ifndef CATIGSMPlane_H
#define CATIGSMPlane_H
...
extern ExportedByCATGitInterfaces IID  IID_CATIGSMPlane;
#else
extern "C" const IID IID_CATIGSMPlane;
#endif
/**
...
class ExportedByCATGitInterfaces CATIGSMPlane : public CATBaseUnknown
{
   CATDeclareInterface;
public: 
 ...
 virtual HRESULT GetPlaneType(int & oT) = 0;
    ...
    /**
      ...
      * @see CATIGSMFactory#CreatePlaneType
      */
...
CATDeclareHandler (CATIGSMPlane, CATBaseUnknown);
#endif
