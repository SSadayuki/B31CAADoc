#ifndef CATIGSMSweepSegment_H
#define CATIGSMSweepSegment_H
// 
...
extern ExportedByCATGitInterfaces IID IID_CATIGSMSweepSegment;
#else
extern "C" const IID IID_CATIGSMSweepSegment;
#endif
/**
* Interface to linear sweep feature. 
* <b>Role</b>: Allows you to access (query and modifications) data 
* of the linear sweep.
* @see CATIGSMFactory#CreateLinearSweep
*/
class ExportedByCATGitInterfaces CATIGSMSweepSegment : public CATBaseUnknown
{
...
public: 
  ...
  */
  virtual HRESULT GetGuideCrv(CATISpecObject_var & oElem) = 0;
  /**
  * Modify first guide curve.
  *   @param iElem
  *      First guide curve feature.
  */
  virtual HRESULT SetGuideCrv(const CATISpecObject_var iElem) = 0;
  /**
  ...
  */
  virtual HRESULT GetGuideCrv(CATISpecObject_var & oElem, const int iI) = 0;
  /**
  ...
  *      Guide curve index : 1 or 2
  */
  virtual HRESULT SetGuideCrv(const CATISpecObject_var iElem, const int iI) = 0;
  /**
  ...
  */
  virtual HRESULT GetGuideSurf(CATISpecObject_var & oElem) = 0;
  /**
  * Sets first guide surface.
  *   @param iElem
  *      First guide surface feature.
  */
  virtual HRESULT SetGuideSurf(const CATISpecObject_var iElem) = 0;
  /**
  ...
  */
  virtual HRESULT GetGuideSurf(CATISpecObject_var & oElem, const int iI) = 0;
  /**
  ...
  *      Guide surface index : 1 or 2
  */
  virtual HRESULT SetGuideSurf(const CATISpecObject_var iElem, const int iI) = 0;
  /**
  ...
  *   @see CATICkeParm, CATGSMBasicLawType
  */
  virtual HRESULT GetLengthLaws(CATISpecObject_var & FirstParamStart, CATISpecObject_var & FirstParamEnd, enum CATGSMBasicLawType & eFirstType, CATISpecObject_var & SecondParamStart, CATISpecObject_var & SecondParamEnd, enum CATGSMBasicLawType & eSecondType) = 0;
  /**
  ...
  *   @see CATICkeParm, CATGSMBasicLawType
  */
  virtual HRESULT SetLengthLaws(const CATISpecObject_var & FirstParamStart, const CATISpecObject_var & FirstParamEnd, const enum CATGSMBasicLawType eFirstType, const CATISpecObject_var & SecondParamStart, const CATISpecObject_var & SecondParamEnd, const enum CATGSMBasicLawType eSecondType) = 0;
  /**
  ...
  *      Direction feature
  */
  virtual HRESULT GetDraftDirection(CATIGSMDirection_var & oElem) = 0;
  /**
  * Sets draft direction.
  *   @param iElem
  *      Direction feature
  */
  virtual HRESULT SetDraftDirection(const CATIGSMDirection_var & iElem) = 0;
  ...
  */
  virtual HRESULT GetDraftAngleDefinitionLocations(CATListValCATISpecObject_var & oListLoc, CATListValCATBaseUnknown_var & oListVal) = 0;
  /**
  ...
  *      Angular parameter
  */
  virtual HRESULT AddDraftAngleDefinitionLocation(const CATISpecObject_var & iLoc, const CATICkeParm_var & iVal) = 0;
  /**
  ...
  *      Position in lists
  */
  virtual HRESULT InsertDraftAngleDefinitionLocationBeforePos(const CATISpecObject_var & iLoc, const CATICkeParm_var & iVal, const int iPos) = 0;
  /**
  * Inserts a geometrical element and a value necessary for draft angle definition
  ...
  *      Position in lists
  */
  virtual HRESULT InsertDraftAngleDefinitionLocationAfterPos(const CATISpecObject_var & iLoc, const CATICkeParm_var & iVal, const int iPos) = 0;
  /**
  ...
  */
  virtual HRESULT GetFirstLengthDefinitionType(enum CATGSMLinearSweepLengthType & oType, CATISpecObject_var & oElem) = 0;
  /**
  ...
  *      Length type
  */
  virtual HRESULT SetFirstLengthDefinitionType(const enum CATGSMLinearSweepLengthType iType, const CATISpecObject_var & iElem = NULL_var) = 0;
  /**
  ...
  *      Length type
  */
  virtual HRESULT GetSecondLengthDefinitionType(enum CATGSMLinearSweepLengthType & oType, CATISpecObject_var & oElem) = 0;
  /**
  ...
  *      Length type
  */
  virtual HRESULT SetSecondLengthDefinitionType(const enum CATGSMLinearSweepLengthType iType, const CATISpecObject_var & iElem = NULL_var) = 0;
...
CATDeclareHandler (CATIGSMSweepSegment, CATBaseUnknown);

#endif // CATIGSMSweepSegment_H
