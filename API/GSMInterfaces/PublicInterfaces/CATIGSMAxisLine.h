...
#ifndef CATIGSMAxisLine_H
#define CATIGSMAxisLine_H
...
extern ExportedByCATGitInterfaces IID IID_CATIGSMAxisLine;
#else
extern "C" const IID IID_CATIGSMAxisLine;
#endif
 ...
 * @see CATIGSMFactory#CreateAxisLine
 */

class ExportedByCATGitInterfaces CATIGSMAxisLine: public CATBaseUnknown
{
  CATDeclareInterface;
  ...
  public:
    ...
    */
   virtual HRESULT GetElement(CATISpecObject_var& ohElement) = 0;
    ...
    *      Element used for computation
    */
   virtual HRESULT SetElement(const CATISpecObject_var ihElement) = 0;
...
CATDeclareHandler (CATIGSMAxisLine, CATBaseUnknown);
#endif
