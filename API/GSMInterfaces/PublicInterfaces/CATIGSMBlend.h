...
#ifndef CATIGSMBlend_H
#define CATIGSMBlend_H
...
extern ExportedByCATGitInterfaces IID IID_CATIGSMBlend ;
#else
extern "C" const IID IID_CATIGSMBlend ;
#endif
 ...
 */
class ExportedByCATGitInterfaces CATIGSMBlend: public CATBaseUnknown
{
  CATDeclareInterface;
  ...
  // --------------------------------------------------------------
     ...
     , const CATISpecObject_var iCurve
     ) = 0;
     ...
     const CATGSMBlendLimitNumber iBlendLimit
     , const CATISpecObject_var iClosingPoint
     ) = 0;
      ...
      */
      virtual HRESULT GetLimits( 
         CATISpecObject_var oCurves[2]
         , int oOrientations[2]
         , CATISpecObject_var oPoints[2]
         , CATISpecObject_var oSupports[2]
         , int oTransitions[2]
         , int oContinuities[2]
         , int oTrimSupports[2]
         )= 0;
     ...
     const CATGSMBlendLimitNumber iBlendLimit
     , const CATGSMBlendTensionType iTensionType 
         , const CATLISTV(CATISpecObject_var) & iTensionValues
     ) = 0;
      ...
      */
      virtual HRESULT GetTension(
     CATGSMBlendTensionType oTensionType[2] 
         , CATLISTV(CATISpecObject_var) * oTensionValues[2]
     ) = 0;
...
CATDeclareHandler( CATIGSMBlend, CATBaseUnknown );
