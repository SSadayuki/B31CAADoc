#ifndef CATIGSMCircleCenterTangent_H
#define CATIGSMCircleCenterTangent_H
...
extern ExportedByCATGitInterfaces IID IID_CATIGSMCircleCenterTangent;
#else
extern "C" const IID IID_CATIGSMCircleCenterTangent ;
#endif
...
* @see CATIGSMFactory#CreateTangentCircle
 */
class ExportedByCATGitInterfaces CATIGSMCircleCenterTangent: public CATBaseUnknown
{
  CATDeclareInterface;
...
public: 
  ...
  */
 virtual HRESULT GetCenterElem(CATISpecObject_var& oCenterElem) = 0;
  ...
  *      Center Elem : a curve or a point
  */
 virtual HRESULT SetCenterElem(const CATISpecObject_var iCenterElem) = 0;
  ...
  *      Tangent Curve
  */
 virtual HRESULT GetTangentCurve(CATISpecObject_var& oTangentCurve) = 0;
  ...
  *      Tangent Curve
  */
 virtual HRESULT SetTangentCurve(const CATISpecObject_var iTangentCurve) = 0;
...
CATDeclareHandler (CATIGSMCircleCenterTangent, CATBaseUnknown);
//------------------------------------------------------------------
