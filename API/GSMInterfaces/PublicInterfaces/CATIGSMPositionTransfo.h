/* -*-c++-*- */
#ifndef CATIGSMPositionTransfo_H
#define CATIGSMPositionTransfo_H
...
extern ExportedByCATGitInterfaces IID IID_CATIGSMPositionTransfo;
#else
extern "C" const IID IID_CATIGSMPositionTransfo;
#endif
/**
 ...
 * @see CATIGSMSweepUnspec#GetPositionTransfo 
 * @see CATIGSMFactory#CreateExplicitSweep
 */
class ExportedByCATGitInterfaces CATIGSMPositionTransfo : public CATBaseUnknown
{
 ...
 CATDeclareInterface;
  ...
  public:
    ...
    *   @see CATIGSMSweepUnspec, CATGSMPositionMode
    */
...
CATDeclareHandler (CATIGSMPositionTransfo, CATBaseUnknown);
#endif // CATIGSMPositionTransfo_H
