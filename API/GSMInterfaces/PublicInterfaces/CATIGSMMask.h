...
#ifndef CATIGSMMask_H
#define CATIGSMMask_H
...
extern ExportedByCATGitInterfaces IID IID_CATIGSMMask;
#else
extern "C" const IID IID_CATIGSMMask;
#endif
 ...
 * 
 */
class ExportedByCATGitInterfaces CATIGSMMask: public CATBaseUnknown
{
   CATDeclareInterface;
...
public:
   ...
   *      Axis system.
   */
   virtual HRESULT GetAxis(CATISpecObject_var& oAxisSystem) = 0;
   ...
   *      Axis system.
   */
   virtual HRESULT SetAxis(const CATISpecObject_var& iAxisSystem) = 0;
   ...
   *      Point1.
   */
   virtual HRESULT GetRefPoint1(CATISpecObject_var& oPoint1) = 0;
   ...
   *      Point2.
   */
   virtual HRESULT GetRefPoint2(CATISpecObject_var& oPoint2) = 0;
   ...
   *      Point1.
   */
   virtual HRESULT SetRefPoint1(const CATISpecObject_var& iPoint1) = 0;
   ...
   *      Point2.
   */
   virtual HRESULT SetRefPoint2(const CATISpecObject_var& iPoint2) = 0;
...
CATDeclareHandler( CATIGSMMask, CATBaseUnknown );
