/* -*-c++-*- */
#ifndef CATIGSMPolyline_H
#define CATIGSMPolyline_H
//
...
//
// CATIGSMPolyline.h
// Define the CATIGSMPolyline interface
//
...
extern ExportedByCATGitInterfaces IID  IID_CATIGSMPolyline;
#else
extern "C" const IID IID_CATIGSMPolyline;
#endif

/**
 * Interface to line corner feature.
 * <b>Role</b>:Allows to access data of the line corner 
 * @see CATIGSMFactory#CreatePolyline
 */
class ExportedByCATGitInterfaces CATIGSMPolyline: public CATBaseUnknown
{
  CATDeclareInterface;
 ...
 *   the point. 
 */ 
      virtual HRESULT InsertElement(const CATISpecObject_var iPoint
         , const int iPosition
         ) = 0;
 ...
 *   the point. 
 */ 
      virtual HRESULT ReplaceElement(const CATISpecObject_var iPoint
         , const int iPosition
         ) = 0;
 ...
 *   The list of points.
 */ 
      virtual HRESULT GetElements(CATLISTV(CATISpecObject_var) & oPoints,
 ...
 *   If no iSupport is provided, remove the support.
      virtual HRESULT SetSupport(const CATISpecObject_var iSupport = NULL_var ) = 0;  
 */
 ...
 *   the point. 
 */ 
	  virtual HRESULT SetPoint(const int iPosition, const CATISpecObject_var iPoint) = 0;
...
CATDeclareHandler (CATIGSMPolyline, CATBaseUnknown);
