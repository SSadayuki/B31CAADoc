/* -*-c++-*- */
#ifndef CATIGSMConnect_H
#define CATIGSMConnect_H
...
extern ExportedByCATGitInterfaces IID  IID_CATIGSMConnect;
#else
extern "C" const IID IID_CATIGSMConnect;
#endif
/**
 ...
 * @see CATIGSMFactory#CreateConnect
 */
class ExportedByCATGitInterfaces CATIGSMConnect : public CATBaseUnknown
{
   CATDeclareInterface;
public: 
   ...
   */ 
 virtual    HRESULT GetFirstCurve   (CATISpecObject_var & oCurve1) = 0;
  /**
   * Gets the second reference curve.
   *   @param oCurve2
   *      new second reference curve
   */
 virtual    HRESULT GetSecondCurve   (CATISpecObject_var & oCurve2) = 0;
  /**
 ...
 virtual    HRESULT GetTrim     (CATBoolean & oTrim) = 0;
   ...
   */ 
 virtual    HRESULT GetBaseCurve   (CATISpecObject_var & oBaseCurve) = 0;
  /**
    * Gets Connect type.
    * <br>
 ...
 virtual    HRESULT GetConnectType(CATGSMConnectType & oType) = 0;
   ...
   *      new first reference curve
   */ 
 virtual    HRESULT SetFirstCurve  (const CATISpecObject_var iCurve1)  = 0;
  /**
   * Sets the second reference curve.
   *   @param iCurve2
   *      new second reference curve
   */
 virtual    HRESULT SetSecondCurve     (const CATISpecObject_var iCurve2)  = 0;
  /**
 ...
 virtual    HRESULT SetTrim              (CATBoolean iTrim) = 0;
   ...
   *      new reference base curve
   */ 
 virtual    HRESULT SetBaseCurve  (const CATISpecObject_var iBaseCurve)  = 0;
  /**
...
CATDeclareHandler (CATIGSMConnect, CATBaseUnknown);
#endif // CATIGSMConnect_H
