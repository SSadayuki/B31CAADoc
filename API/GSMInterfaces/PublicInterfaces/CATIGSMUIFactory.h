...
#ifndef CATIGSMUIFactory_H
#define CATIGSMUIFactory_H
...
extern ExportedByCATGitInterfaces IID  IID_CATIGSMUIFactory;
#else
extern "C" const IID IID_CATIGSMUIFactory;
#endif
...
class ExportedByCATGitInterfaces CATIGSMUIFactory : public CATBaseUnknown
{
   CATDeclareInterface;
public: 
    ...
    *		<br> Note: Default is "CATIGSMUICommandCreation"
    *   @param Behavior
    ...
    *   @param Name
    *		The name of the created CATCommand
    *		<br> Note:Default is "CATIGSMUICommandEdit"
    *   @param Behavior
    *		The behavior parameter of the CATStateCommand
    *		<br> Note:Default is NULL
    *   @param iMode
    ...
    *	@see CATCommand, CATStateCommand
    */
   virtual CATCommand *EditCommand(CATISpecObject_var &EditedSpec, const CATString & Name="CATIGSMUICommandEdit", CATDlgEngBehavior Behavior=NULL, CATCommandMode iMode=CATCommandModeExclusive) = 0;

};
CATDeclareHandler (CATIGSMUIFactory, CATBaseUnknown);
