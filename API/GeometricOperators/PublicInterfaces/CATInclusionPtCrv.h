#ifndef CATInclusionPtCrv_H
#define CATInclusionPtCrv_H
...
#include "CATCreateInclusionPtCrv.h"
 ...
 *<ul>
 *<li>The CATInclusionPtCrv operator is created with the <tt>CreateInclusion</tt> method and 
 ...
 *</ul>
 */
class CATInclusionPtCrv : public CATCGMOperator
{
  CATCGMVirtualDeclareClass(CATInclusionPtCrv);
 public:
/**
 * @nodoc
 * Use the <tt>CreateInclusion</tt> global method.
 */
   CATInclusionPtCrv(CATGeoFactory * factory);

/**
 * Destructor.
 */
   virtual ~CATInclusionPtCrv();
...
/**
 * Skips to the next solution point of <tt>this</tt> CATInclusionPtCrv operator.
...
/**
 * @nodoc
 * Creates the next solution point of <tt>this</tt> CATInclusionPtCrv operator.
