#ifndef CATNurbsSurfaceTools_H 
#define CATNurbsSurfaceTools_H 
...
class ExportedByGeoNurbsTools CATNurbsSurfaceTools : public CATGeoOperator 
{
  CATCGMVirtualDeclareClass(CATNurbsSurfaceTools);
public:

/** 
 * @nodoc
 * Use the <tt>CATCreateNurbsSurfaceTools</tt> global method.
 */
  CATNurbsSurfaceTools (CATGeoFactory * iFactory);

/**
 * Destructor.
 */
  virtual ~CATNurbsSurfaceTools ();

/** 
 * @nodoc
 * Sets the tolerance of minimal 3D size for the geometric elements created.
 * @param iTolKnotConfusion
 * The tolerance to be specified.
...
/** 
 * @nodoc
 * Sets the maximum degree authorized in the SetDegree method.
 ...
 */
  virtual CATNurbsToolsInfo GetDegrees (int &oDegreeU,
                                        int &oDegreeV) = 0;
 ...
 * Use @href CATNurbsToolsInfo include to see all the information values.
 */
  virtual CATNurbsToolsInfo GetNumberOfKnots (int &oNumberOfKnotsU,
 ...
 * Use @href CATNurbsToolsInfo include to see all the information values.
 */
  virtual CATNurbsToolsInfo GetNumberOfControlPoints (int &oNumberOfControlPointsU,
 ...
 * Use @href CATNurbsToolsInfo include to see all the information values.
 */
  virtual CATNurbsToolsInfo UKnotRankToKnotValue (const int iKnotRank,
                                                  double   &oKnotValue) = 0;
 ...
 * Use @href CATNurbsToolsInfo include to see all the information values.
 */
  virtual CATNurbsToolsInfo VKnotRankToKnotValue (const int iKnotRank,
                                                  double   &oKnotValue) = 0;
 ...
 * Use @href CATNurbsToolsInfo include to see all the information values.
 */
  virtual CATNurbsToolsInfo UKnotValueToKnotRank (const double iKnotValue,
                                                  int         &oKnotRank) = 0;
 ...
 * Use @href CATNurbsToolsInfo include to see all the information values.
 */
  virtual CATNurbsToolsInfo VKnotValueToKnotRank (const double iKnotValue,
                                                  int         &oKnotRank) = 0;
 ...
 * Use @href CATNurbsToolsInfo include to see all the information values.
 */
  virtual CATNurbsToolsInfo UKnotInsertion (const double iKnotValue, 
 ...
 * Use @href CATNurbsToolsInfo include to see all the information values.
 */
  virtual CATNurbsToolsInfo VKnotInsertion (const double iKnotValue, 
                                            const int    iMultiplicity = 0) = 0;
 ...
 * Use @href CATNurbsToolsInfo include to see all the information values.
 */
  virtual CATNurbsToolsInfo UMultipleKnotInsertion (const int      iNumberOfKnotsToInsert, 
 ...
 * Use @href CATNurbsToolsInfo include to see all the information values.
 */
  virtual CATNurbsToolsInfo VMultipleKnotInsertion (const int      iNumberOfKnotsToInsert, 
                                                    const double * iKnotValues, 
                                                    const int    * iMultiplicities = 0) = 0;
  
/**
 * Removes a knot along U.
 * This method deforms the surface. Use @href CATNurbsSurfaceTools#GetDeformation to compute this deformation.
 * @param iKnotRank
 ...
 * Use @href CATNurbsToolsInfo include to see all the information values.
 */
  virtual CATNurbsToolsInfo UKnotReplace (const int    iKnotRank, 
 ...
 * Use @href CATNurbsToolsInfo include to see all the information values.
 */
  virtual CATNurbsToolsInfo VKnotReplace (const int    iKnotRank, 
                                          const double iKnotNewValue,  
                                          const int    iLeftContinuity  = 0, 
                                          const int    iRightContinuity = 0) = 0;
 ...
 * Use @href CATNurbsToolsInfo include to see all the information values. 
 */
  virtual CATNurbsToolsInfo ImposeParametrizations (CATSurface * iSurface,  
 ...
 * Use @href CATNurbsToolsInfo include to see all the information values. 
 */
  virtual CATNurbsToolsInfo UImposeParametrization (CATCurve * iCurve,  
                                                    const int  iLeftContinuity  = 0, 
                                                    const int  iRightContinuity = 0) = 0;
 ...
 * Use @href CATNurbsToolsInfo include to see all the information values. 
 */
  virtual CATNurbsToolsInfo VImposeParametrization (CATCurve * iCurve,  
                                                    const int  iLeftContinuity  = 0, 
                                                    const int  iRightContinuity = 0) = 0;
  
/**
 * Modifies the knot vector along U. 
 * This method deform the Surface. Use @href CATNurbsSurfaceTools#GetDeformation to compute this deformation
 ...
 * Use @href CATNurbsToolsInfo include to see all the information values.
 */
  virtual CATNurbsToolsInfo UChangeKnotVector (const CATKnotVector * iNewKnotVector, 
                                               const int             iLeftContinuity  = 0, 
                                               const int             iRightContinuity = 0) = 0;
 ...
 * Use @href CATNurbsToolsInfo include to see all the information values.
 */
  virtual CATNurbsToolsInfo VChangeKnotVector (const CATKnotVector * iNewKnotVector, 
                                               const int             iLeftContinuity  = 0, 
                                               const int             iRightContinuity = 0) = 0;
 ...
 * Use @href CATNurbsSurfaceTools#GetDeformation to compute this deformation.
 * @param iKnotRank
 * The rank of the knot to be removed. The rank starts from 1.
 * @param iMultiplicity
 ...
 * Use @href CATNurbsToolsInfo include to see all the information values.
  */
  virtual CATNurbsToolsInfo USetMultiplicity (const int iKnotRank, 
 ...
 * Use @href CATNurbsToolsInfo include to see all the information values.
 */
  virtual CATNurbsToolsInfo VSetMultiplicity (const int iKnotRank, 
                                              const int iMultiplicity) = 0;
 ...
 * Use @href CATNurbsToolsInfo include to see all the information values.
 */
  virtual CATNurbsToolsInfo ActiveSplits (const double iStartKnotValuesU,  
 ...
 * Use @href CATNurbsToolsInfo include to see all the information values. 
 */
  virtual CATNurbsToolsInfo UActiveSplit (const double iStartKnotValues,  
 ...
 * Use @href CATNurbsToolsInfo include to see all the information values. 
 */
  virtual CATNurbsToolsInfo VActiveSplit (const double iStartKnotValues,  
                                          const double iEndKnotValues) = 0;
 ...
 * Use @href CATNurbsToolsInfo include to see all the information values. 
 */
  virtual CATNurbsToolsInfo SetDegrees (const int iDegreeU,  
                                        const int iDegreeV,
                                        const int iLeftContinuityU  = 0, 
                                        const int iRightContinuityU = 0,
                                        const int iLeftContinuityV  = 0, 
 ...
 */
  virtual CATNurbsToolsInfo USetDegree (const int iDegreeU,
                                        const int iLeftContinuityU  = 0, 
 ...
 * Use @href CATNurbsToolsInfo include to see all the information values. 
 */
  virtual CATNurbsToolsInfo VSetDegree (const int iDegreeV,  
                                        const int iLeftContinuityV  = 0, 
                                        const int iRightContinuityV = 0) = 0;
 ...
 * </dl>
 * If an error has occurred, use @href CATNurbsSurfaceTools#GetInfo for more information.
 */
  virtual int Run () = 0;
 ...
 * Pointer is 0 if an error has occurred (use @href CATNurbsSurfaceTools#GetInfo for more information).
 */
 ...
 * It can be called several times and before @href CATNurbsSurfaceTools#Run.
 * @param oParamValueU
 ...
 * @nodoc
 * @return
 * The pointer to the current surface.
 * 0:  if  an error has occurred
 */
  virtual CATSurface * GetCurrentSurface () = 0;
};
 ...
 * To be deleted with the usual C++ <tt>delete</tt> operator after use.
 */
