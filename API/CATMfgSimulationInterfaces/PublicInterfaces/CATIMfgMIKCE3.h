...
//===================================================================
#ifndef CATIMfgMIKCE3_H
#define CATIMfgMIKCE3_H
...
extern ExportedByCATMfgSimulationItfCPP IID IID_CATIMfgMIKCE3;
#else
extern "C" const IID IID_CATIMfgMIKCE3 ;
#endif
 ...
 * simulation.
 */
class ExportedByCATMfgSimulationItfCPP CATIMfgMIKCE3: public CATBaseUnknown
{
  CATDeclareInterface;
...
CATDeclareHandler( CATIMfgMIKCE3, CATBaseUnknown) ;
//------------------------------------------------------------------
