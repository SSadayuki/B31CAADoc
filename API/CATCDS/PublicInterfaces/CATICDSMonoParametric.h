#ifndef CATICDSMonoParametric_H
#define CATICDSMonoParametric_H
 ...
 */
class ExportedByCDSInterface CATICDSMonoParametric : public CATICDSGeometryLeaf
{
  CATICDSDeclareInterface(CATICDSMonoParametric)
