#ifndef CATICDSLine2D_H
#define CATICDSLine2D_H
 ...
 */
class ExportedByCDSInterface CATICDSLine2D : public CATICDSMonoParametric2D
{
  CATICDSDeclareInterface(CATICDSLine2D)
...
public:
  ...
  /**
   * Creates an instance of the CATICDSLine2D geometry.
   * @param ipFactory.
   ...
   */
  static CATICDSLine2D* Create(CATICDSFactory* ipFactory,
