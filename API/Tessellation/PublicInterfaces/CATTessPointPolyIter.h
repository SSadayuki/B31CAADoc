...
#include "CATCGMTessPointPolyIter.h"
 ...
 */
class ExportedByTessAPI CATTessPointPolyIter: public CATCGMTessPointPolyIter
{
public:
  /**
   * @nodoc
...
protected :
 ...
 virtual void GetPointWidthUV(double & ioWidthU,double & ioWidthV ) const;
