#ifndef CATSysErrorDef_H
#define CATSysErrorDef_H
...
#ifndef _WINERROR_		// Avoid redefinition of Windows HRESULT which has already
/**
 * @nodoc
 */
#define _WINERROR_		// been defined in winerror.h included by IUnknown.h
...
/**
 * @nodoc 
 * HRESULT value for a non implemented method.
 */
...
/**
 *
 * Generic test for failure on any status value (negative numbers
 * indicate failure).
 * @see HRESULT
 */
...
/**
 * @nodoc
 * HRESULT value for a successful execution.
 */
#define S_OK       ((HRESULT)0x00000000L)
 
/**
 * @nodoc
 * Value for an unspecified failure.
 */                       
...
/**
 * @nodoc
 * Dassault Systemes internal HRESULT
 */
typedef HRESULT CRITICAL_HRESULT;
#endif // CATSysErrorDef_H
