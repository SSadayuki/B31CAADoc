#ifndef CATITPSAxisStraightness_H
#define CATITPSAxisStraightness_H
...
extern "C" const IID IID_CATITPSAxisStraightness;
 ...
 * from a axis of a cylindrical surface,
...
class CATITPSAxisStraightness : public IUnknown
{
  public:
