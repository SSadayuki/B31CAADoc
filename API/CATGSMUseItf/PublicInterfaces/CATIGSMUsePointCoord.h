/* -*-c++-*- */
#ifndef CATIGSMUsePointCoord_H
#define CATIGSMUsePointCoord_H
// 
...
extern ExportedByCATGSMUseItf IID  IID_CATIGSMUsePointCoord;
#else
extern "C" const IID IID_CATIGSMUsePointCoord;
#endif
/**
 ...
 */
class ExportedByCATGSMUseItf CATIGSMUsePointCoord : public CATBaseUnknown
{
   CATDeclareInterface;
public: 
...
CATDeclareHandler (CATIGSMUsePointCoord, CATBaseUnknown);
#endif
