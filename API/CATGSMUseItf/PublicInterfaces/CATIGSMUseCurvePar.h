/* -*-c++-*- */
#ifndef CATIGSMUseCurvePar_H
#define CATIGSMUseCurvePar_H
...
extern ExportedByCATGSMUseItf IID  IID_CATIGSMUseCurvePar;
#else
extern "C" const IID   IID_CATIGSMUseCurvePar;
#endif
 ...
 * @see CATIGSMUseFactory#CreateCurvePar
 */

class ExportedByCATGSMUseItf CATIGSMUseCurvePar : public CATBaseUnknown
{
 CATDeclareInterface;
 ...
 */
  ...
  *      new passing point
  */
 virtual    HRESULT GetPassingPoint (CATIMmiMechanicalFeature_var & oPassingPoint)   = 0;
  ...
  *      new passing point
  */
 virtual    HRESULT SetPassingPoint   (const CATIMmiMechanicalFeature_var iPassingPoint) = 0;
...
CATDeclareHandler (CATIGSMUseCurvePar, CATBaseUnknown);
#endif // CATIGSMUseCurvePar_H
