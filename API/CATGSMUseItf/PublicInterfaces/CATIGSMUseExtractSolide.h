/* -*-c++-*- */
#ifndef CATIGSMUseExtractSolide_H
#define CATIGSMUseExtractSolide_H
...
extern ExportedByCATGSMUseItf IID  IID_CATIGSMUseExtractSolide;
#else
extern "C" const IID IID_CATIGSMUseExtractSolide;
#endif

/**
 * Interface to extract solid feature. 
 * <b>Role</b>: Allows you to access data of a solid extracted 
 * @see CATIGSMUseFactory#CreateExtractSolide
 */

class ExportedByCATGSMUseItf CATIGSMUseExtractSolide : public CATBaseUnknown
{
   CATDeclareInterface;
...
CATDeclareHandler (CATIGSMUseExtractSolide, CATBaseUnknown);
#endif // CATIGSMUseExtractSolide_H
