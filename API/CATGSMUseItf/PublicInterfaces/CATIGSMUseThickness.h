#ifndef CATIGSMUseThickness_H
#define CATIGSMUseThickness_H
...
extern ExportedByCATGSMUseItf IID  IID_CATIGSMUseThickness;
#else
extern "C" const IID IID_CATIGSMUseThickness;
#endif
...
class ExportedByCATGSMUseItf CATIGSMUseThickness : public CATBaseUnknown
{
...
CATDeclareHandler(CATIGSMUseThickness,CATBaseUnknown);

#endif // CATIGSMUseThickness_H
