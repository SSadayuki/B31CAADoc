/* -*-c++-*- */
#ifndef CATIGSMUseFilletTriTangent_H
#define CATIGSMUseFilletTriTangent_H
...
extern ExportedByCATGSMUseItf IID  IID_CATIGSMUseFilletTriTangent;
#else
extern "C" const IID IID_CATIGSMUseFilletTriTangent;
#endif
/** 
 ...
 * @see CATIGSMUseFactory#CreateFillet
 */
class ExportedByCATGSMUseItf CATIGSMUseFilletTriTangent : public CATBaseUnknown
{
   CATDeclareInterface;
public:  
 ...
 /**
    ...
    */ 
 virtual    HRESULT GetRemoveElem(CATIMmiMechanicalFeature_var & oElem) = 0;
  ...
  /**
    ...
    *      Remove support surface feature
    */ 
 virtual    HRESULT SetRemoveElem(const CATIMmiMechanicalFeature_var iElem) = 0;
...
CATDeclareHandler (CATIGSMUseFilletTriTangent, CATBaseUnknown);
#endif // CATIGSMUseFilletTriTangent_H
