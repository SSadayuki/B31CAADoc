/* -*-c++-*- */
#ifndef CATIGSMUseExtrude_H
#define CATIGSMUseExtrude_H
...
extern ExportedByCATGSMUseItf IID  IID_CATIGSMUseExtrude;
#else
extern "C" const IID IID_CATIGSMUseExtrude;
#endif
/**
 ...
 * <br>  
 * @see CATIGSMUseFactory#CreateExtrude
 */
class ExportedByCATGSMUseItf CATIGSMUseExtrude : public CATBaseUnknown
{
   CATDeclareInterface;
...
public: 
  ...
  /**
    ...
    *      direction 
    */
   virtual    CATIGSMUseDirection_var GetDir() = 0;
  ...
  /**
    ...
    */
   virtual    HRESULT SetDir  (const CATIGSMUseDirection_var iElem1) = 0;
...
CATDeclareHandler (CATIGSMUseExtrude, CATBaseUnknown);
#endif // CATIGSMUseExtrude_H
