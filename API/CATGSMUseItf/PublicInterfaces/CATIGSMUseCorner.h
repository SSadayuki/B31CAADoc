...
/* -*-c++-*- */
#ifndef CATIGSMUseCorner_H
#define CATIGSMUseCorner_H
...
extern ExportedByCATGSMUseItf IID  IID_CATIGSMUseCorner;
#else
extern "C" const IID   IID_CATIGSMUseCorner;
#endif
 ...
 * and a radius
 * @see CATIGSMUseFactory#CreateCorner 
 * @see CATIGSMUseFactory#Create3DCorner 
 */
class ExportedByCATGSMUseItf CATIGSMUseCorner : public CATBaseUnknown
{
   CATDeclareInterface;
public:
  /**
...
CATDeclareHandler (CATIGSMUseCorner, CATBaseUnknown);
#endif // CATIGSMUseCorner_H
