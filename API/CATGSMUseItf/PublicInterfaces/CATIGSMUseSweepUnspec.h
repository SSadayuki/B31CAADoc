/* -*-c++-*-    */
#ifndef CATIGSMUseSweepUnspec_H
#define CATIGSMUseSweepUnspec_H
...
extern ExportedByCATGSMUseItf IID IID_CATIGSMUseSweepUnspec;
#else
extern "C" const IID IID_CATIGSMUseSweepUnspec;
#endif
/**
  ...
  * @see CATIGSMUsePositionTransfo
  * @see CATIGSMUseFactory#CreateExplicitSweep
  */
class ExportedByCATGSMUseItf CATIGSMUseSweepUnspec : public CATBaseUnknown
{
 ...
 virtual HRESULT IsSketchAxisUsedAsDefault(CATBoolean & oBoolean) = 0;
    ...
    * @see CATIGSMUsePositionTransfo 
    */
 virtual HRESULT GetPositionedProfile(CATIMmiMechanicalFeature_var & oElem) = 0;
   /**
    * Sets the positioning transformation.
    *   @param iElem
    *      Positioning transformation feature
    */
 virtual HRESULT SetPositionedProfile(CATIMmiMechanicalFeature_var & iElem) = 0;
 ...
 virtual HRESULT SetPosMode(const enum CATGSMPositionMode Elem) = 0;
   ...
   */
 virtual HRESULT GetFittingPoints(CATIMmiMechanicalFeature_var & oElem1, CATIMmiMechanicalFeature_var & oElem2) = 0;
    ...
    */
 virtual HRESULT SetFittingPoints(const CATIMmiMechanicalFeature_var iElem1, const CATIMmiMechanicalFeature_var iElem2) = 0;
 ...
 virtual HRESULT SetMode(const enum CATGSMExplicitSweepCase iElem) = 0;
    ...
    * @see CATIGSMUseDirection 
    */
 virtual HRESULT GetPullingDirection(CATIGSMUseDirection_var & oDir) = 0;
   /**
    ...
    * @see CATIGSMUseDirection 
    */
 virtual HRESULT SetPullingDirection(const CATIGSMUseDirection_var & iDir) = 0;
...
CATDeclareHandler (CATIGSMUseSweepUnspec, CATBaseUnknown);
#endif // CATIGSMUseSweepUnspec_H
