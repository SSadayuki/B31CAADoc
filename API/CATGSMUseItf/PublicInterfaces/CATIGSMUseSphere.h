/* -*-c++-*- */
#ifndef CATIGSMUseSphere_H
#define CATIGSMUseSphere_H
...
extern ExportedByCATGSMUseItf IID  IID_CATIGSMUseSphere;
#else
extern "C" const IID IID_CATIGSMUseSphere;
#endif
/**
 ...
 * @see CATIGSMUseFactory#CreateSphere
 */
class ExportedByCATGSMUseItf CATIGSMUseSphere : public CATBaseUnknown
{
   CATDeclareInterface;
public: 
  ...
  /**
    ...
    */
    enum CATIGSMUseSphereLimitation {Angles = 0,Whole = 1};
    ...
    *      sphere axis
    */
    virtual HRESULT GetAxis(CATIMmiMechanicalFeature_var& oAxis) = 0;
    /**
    ...
    *      New sphere axis.
    */
   virtual    HRESULT SetAxis(const CATIMmiMechanicalFeature_var iAxis) = 0;
    /**
   ...
   virtual    HRESULT SetEndMeridianAngle  (const CATICkeParm_var iAng4) =0; 
    /**
      ...
      *      sphere limitation
      */
   virtual HRESULT GetLimitation(CATIGSMUseSphereLimitation & oLimit) = 0;
    /**
      ...
      */
   virtual HRESULT SetLimitation(const CATIGSMUseSphereLimitation  iLimit) = 0;


};
CATDeclareHandler (CATIGSMUseSphere, CATBaseUnknown);
#endif // CATIGSMUseSphere_H
