/* -*-c++-*- */
#ifndef CATIGSMUseCircleBitangentPoint_H
#define CATIGSMUseCircleBitangentPoint_H
// 
...
extern ExportedByCATGSMUseItf IID  IID_CATIGSMUseCircleBitangentPoint;
#else
extern "C" const IID IID_CATIGSMUseCircleBitangentPoint;
#endif
/**
 ...
 */
class ExportedByCATGSMUseItf CATIGSMUseCircleBitangentPoint : public CATBaseUnknown
{
   CATDeclareInterface;
public: 
  ...
  *      second curve
  */
 virtual HRESULT GetSecondCurve(CATIMmiMechanicalFeature_var& oSecondCurve) = 0;
  ...
  *      second curve
  */
 virtual HRESULT SetSecondCurve(const CATIMmiMechanicalFeature_var iSecondCurve) = 0;
...
CATDeclareHandler (CATIGSMUseCircleBitangentPoint, CATBaseUnknown);
#endif
