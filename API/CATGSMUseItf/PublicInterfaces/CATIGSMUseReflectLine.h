/* -*-c++-*- */
#ifndef CATIGSMUseReflectLine_H
#define CATIGSMUseReflectLine_H
...
extern ExportedByCATGSMUseItf IID  IID_CATIGSMUseReflectLine;
#else
extern "C" const IID IID_CATIGSMUseReflectLine;
#endif
 ...
 * @see CATIGSMUseFactory#CreateReflectLine
 */
class ExportedByCATGSMUseItf CATIGSMUseReflectLine : public CATBaseUnknown
{
   CATDeclareInterface;
public:
...
CATDeclareHandler (CATIGSMUseReflectLine, CATBaseUnknown);
#endif // CATIGSMUseReflectLine_H
