#ifndef CATIGSMUseCylinder_H
#define CATIGSMUseCylinder_H
...
extern ExportedByCATGSMUseItf IID IID_CATIGSMUseCylinder;
#else
extern "C" const IID IID_CATIGSMUseCylinder ;
#endif
 ...
 * @see CATIGSMUseFactory#CreateCylinder
 */
class ExportedByCATGSMUseItf CATIGSMUseCylinder: public CATBaseUnknown
{
  CATDeclareInterface;
  ...
  public:
    ...
    *      Center of cylinder
    */
   virtual    CATIMmiMechanicalFeature_var   GetCenter() = 0;
  ...
  /**
    ...
    */
   virtual    HRESULT SetCenter  (const CATIMmiMechanicalFeature_var ihCenter) = 0;
  ...
  /**
    ...
    */
   virtual    HRESULT SetDir  (const CATIGSMUseDirection_var ihDir) = 0;
...
CATDeclareHandler (CATIGSMUseCylinder, CATBaseUnknown);
//------------------------------------------------------------------
