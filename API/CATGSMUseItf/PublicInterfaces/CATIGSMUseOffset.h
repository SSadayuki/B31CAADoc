/* -*-c++-*- */
#ifndef CATIGSMUseOffset_H
#define CATIGSMUseOffset_H
// 
...
extern ExportedByCATGSMUseItf IID  IID_CATIGSMUseOffset;
#else
extern "C" const IID IID_CATIGSMUseOffset;
#endif
/**
 ...
 *  
 * @see CATIGSMUseFactory#CreateOffset
 */
class ExportedByCATGSMUseItf CATIGSMUseOffset : public CATBaseUnknown
{
   CATDeclareInterface;
public: 
   ...
   *      Offset Surface
   */ 
 virtual    HRESULT GetProfil (CATIMmiMechanicalFeature_var & oElem) = 0;
  /**
  ...
  */
 virtual    HRESULT SetProfil    (const CATIMmiMechanicalFeature_var iElem) = 0;
 ...
 *   Offset invalid face 
 */ 
 virtual     HRESULT AddTrickyFace  (const CATIMmiMechanicalFeature_var  iTrickyFace) = 0;
...
CATDeclareHandler (CATIGSMUseOffset, CATBaseUnknown);
#endif // CATIGSMUseOffset_H
