/* -*-c++-*- */
#ifndef CATIGSMUseFill_H
#define CATIGSMUseFill_H
...
extern ExportedByCATGSMUseItf IID  IID_CATIGSMUseFill;
#else
extern "C" const IID IID_CATIGSMUseFill;
#endif
/**
...
* @see CATIGSMUseFactory#CreateFill
*/
class ExportedByCATGSMUseItf CATIGSMUseFill : public CATBaseUnknown
{
  CATDeclareInterface;
public: 
  ...
  *      curve boundary
  */
  virtual HRESULT AddBound(CATIMmiMechanicalFeature_var & iBoundary) = 0;
  ...
  */
  virtual HRESULT InsertBoundAfterPosition(CATIMmiMechanicalFeature_var & iBoundary,int iPos) = 0;
  ...
  *      position of the curve boundary in the list of boundaries
  */
  virtual HRESULT InsertBoundBeforePosition(CATIMmiMechanicalFeature_var & iBoundary,int iPos) = 0;
  ...
  *      position of the curve boundary in the list of boundaries
  */
  virtual HRESULT GetBoundPosition(CATIMmiMechanicalFeature_var & oBoundary,int & Pos) = 0;
  ...
  *      position of the curve boundary in the list of boundaries
  */
  virtual HRESULT GetBoundAtPosition(CATIMmiMechanicalFeature_var & oBoundary,int iPos) = 0;
  ...
  *      position of the curve boundary in the list of boundaries
  */
  virtual HRESULT ReplaceBoundAtPosition(CATIMmiMechanicalFeature_var & iBoundary,int iPos) = 0;
  ...
  *      list of supports
  */
  virtual HRESULT GetAllBoundaries(CATLISTV(CATIMmiMechanicalFeature_var) & oBoundary,
    CATLISTV(CATIMmiMechanicalFeature_var) & oSupport) =0;
  ...
  *      support
  */
  virtual HRESULT AddSupport(CATIMmiMechanicalFeature_var & iBoundary, CATIMmiMechanicalFeature_var & iSupport) = 0;
  ...
  *      position of the curve boundary in the list of boundaries
  */
  virtual HRESULT GetSupportAtPosition(CATIMmiMechanicalFeature_var & oSupport,int iPos) = 0;
  ...
  *      position of the curve boundary in the list of boundaries
  */
  virtual HRESULT ReplaceSupportAtPosition(CATIMmiMechanicalFeature_var & iSupport,int iPos) = 0;
  ...
  */ 
  virtual HRESULT GetConstraint(CATIMmiMechanicalFeature_var & oConstraint) = 0;
  ...
  *      new constraint element
  */ 
  virtual HRESULT SetConstraint(const CATIMmiMechanicalFeature_var iConstraint)  = 0;
  ...
  * ======== ONLY USE IN FSS ==============
  */ 
  virtual HRESULT GetConstraints(CATLISTV(CATIMmiMechanicalFeature_var)& oSpecObjectsList)=0;
  ...
  * ======== ONLY USE IN FSS ==============
  */ 
  virtual HRESULT AppendConstraint(const CATIMmiMechanicalFeature_var ihSpecObject)=0;
  ...
  * ======== ONLY USE IN FSS ==============
  */ 
  virtual HRESULT ReplaceConstraint(int i, const CATIMmiMechanicalFeature_var& ihSpecObject)=0;
  ...
  */ 
  ...
  /**
  * @deprecated V5R26 
  * Use @href CATIGSMUseFill#SetAdvancedTolerantMode
  ...
  */
  ...
  /**
  * @deprecated V5R26 
  * Use @href CATIGSMUseFill#GetAdvancedTolerantMode
  ...
  */
  virtual HRESULT AddWireOnInnerBoundary(CATIMmiMechanicalFeature_var & iWire, int iBoundaryNo = -1) = 0;
  ...
  */ 
  virtual HRESULT InsertWireAfterPosOnInnnerBoundary(CATIMmiMechanicalFeature_var & iWire, int iBoundaryNo, int iPos) = 0;
  ...
  *      Position of the wire in the list of wires of an 'Inner Boundary'
  */
  virtual HRESULT InsertWirBeforePosOnInnnerBoundary(CATIMmiMechanicalFeature_var & iWire, int iBoundaryNo, int iPos) = 0;
  ...
  *      Position of the wire in the list of wires of an 'Inner Boundary'
  */
  virtual HRESULT GetWirePosOnInnerBoundary(CATIMmiMechanicalFeature_var & iWire, int &iBoundaryNo, int & oPos) = 0;
  ...
  *      Position of the wire in the list of wires of an 'Inner Boundary'
  */
  virtual HRESULT GetWireAtPosOnInnerBoundary(CATIMmiMechanicalFeature_var & oWire, int &iBoundaryNo, int & iPos) = 0;
  ...
  *      Position of the wire in the list of wires of an 'Inner Boundary'
  */
  virtual HRESULT ReplaceWireAtPosOnInnerBoundary(CATIMmiMechanicalFeature_var & iWire, int iBoundaryNo, int iPos) = 0;
  ...
  *      The inner boundary number
  */
  virtual HRESULT GetAllWiresOnInnerBoundary(CATLISTV(CATIMmiMechanicalFeature_var) & oWires,
    CATLISTV(CATIMmiMechanicalFeature_var) & oSupports, int iBoundaryNo) =0;
  ...
  *      The inner boundary number
  */
  virtual HRESULT AddSupportOnInnerWire(CATIMmiMechanicalFeature_var & iWire, CATIMmiMechanicalFeature_var & iSupport, int iBoundaryNo) = 0;
  ...
  */
  virtual HRESULT GetSupportAtPosOnInnerBoundary(CATIMmiMechanicalFeature_var & oSupport, int iBoundaryNo, int iPos) = 0;
  ...
  *      Position of the wire in the list of boundaries of an Inner Boundary
  */
  virtual HRESULT ReplaceSupportAtPosOnInnerBoundary(CATIMmiMechanicalFeature_var & iSupport, int iBoundaryNo, int iPos) = 0;
  ...
  *      Position of the wire in the list of boundaries of an Inner Boundary
  */
  virtual HRESULT GetWireContOnInnerBoundary(enum CATGSMContinuity &oContinuity, int iBoundaryNo, int iPos) = 0;
  ...
  */
  virtual HRESULT SetCheckTrimMode(const CATBoolean & iCheckTrimMode) = 0;
  ...
  *		Defines if a popup window will appear in case the fill construction required a trim.
  */
  virtual HRESULT GetCheckTrimMode(CATBoolean & oCheckTrimMode) = 0;

};
CATDeclareHandler (CATIGSMUseFill, CATBaseUnknown);
#endif // CATIGSMUseFill_H
