/* -*-c++-*- */
#ifndef CATIGSMUseCircleCtrRad_H
#define CATIGSMUseCircleCtrRad_H
...
extern ExportedByCATGSMUseItf IID  IID_CATIGSMUseCircleCtrRad;
#else
extern "C" const IID IID_CATIGSMUseCircleCtrRad;
#endif
/**
 ...
 */
class ExportedByCATGSMUseItf CATIGSMUseCircleCtrRad : public CATBaseUnknown
{
   CATDeclareInterface;
public: 
 ...
 */
 ...
 virtual HRESULT IsGeodesic(CATBoolean & oGeodesic) = 0;
  /**
    ...
    */
 virtual    HRESULT GetFirstDirection(CATIGSMUseDirection_var & oElem) = 0;
  ...
  /**
    ...
    * @see CATIGSMUseDirection
    */
 virtual    HRESULT SetFirstDirection(const CATIGSMUseDirection_var iElem) = 0;
...
CATDeclareHandler (CATIGSMUseCircleCtrRad, CATBaseUnknown);
#endif
