/* -*-c++-*- */
#ifndef CATIGSMUseExtrapol_H
#define CATIGSMUseExtrapol_H
...
extern ExportedByCATGSMUseItf IID  IID_CATIGSMUseExtrapol;
#else
extern "C" const IID IID_CATIGSMUseExtrapol;
#endif
 ...
 * @see CATIGSMUseFactory#CreateExtrapol
 */
class ExportedByCATGSMUseItf CATIGSMUseExtrapol : public CATBaseUnknown
{
   CATDeclareInterface;
public: 
  /**
    ...
    */ 
 virtual    HRESULT GetElemToExtrapol(CATIMmiMechanicalFeature_var & oElem) = 0;
  ...
  /**
    ...
    *      curve or surface feature to extrapolate
    */ 
 virtual    HRESULT SetElemToExtrapol(const CATIMmiMechanicalFeature_var iElem) = 0;
  ...
  */ 
 virtual    HRESULT RemoveExtrapolations(const CATLISTV(CATIMmiMechanicalFeature_var) & iListElements) = 0;
 ...
 virtual    HRESULT RemoveAllExtrapolationsExceptTheFirstOne() = 0;
  ...
  /**
  * @deprecated V5R26 CATIGSMUseExtrapol#GetBoundary
  ...
  */ 
 virtual    HRESULT GetBoundary(CATIMmiMechanicalFeature_var & ospElem) = 0;
 ...
 /**
    ...
    */ 
 virtual    HRESULT GetBoundary(const int & iPosition, CATIMmiMechanicalFeature_var & oElem) = 0;
  ...
  *      list of boundaries
  */
 virtual    HRESULT GetAllBoundaries(CATLISTV(CATIMmiMechanicalFeature_var) & oListElements) = 0;
  
  /**
  * @deprecated V5R26 CATIGSMUseExtrapol#SetBoundary
  * <p>This method is deprecated because the model has changed to enable to set several boundaries.</p>
  * <p><b>Migration instructions</b>: use the signature that uses an integer as the first argument.</p>
  * Example: "SetBoundary(ispElem)" should be replaced with "SetBoundary(1, ispElem)".
  */ 
 virtual    HRESULT SetBoundary(const CATIMmiMechanicalFeature_var ispElem) = 0;
 ...
 /**
    ...
    *         <li>if iPosition > N+1, the method fails.</li>
    *      <ul>
    *   @param ispElem
    *      boundary point (or curve) of extrapolated curve (or surface)
    */ 
 virtual    HRESULT SetBoundary(const int & iPosition, const CATIMmiMechanicalFeature_var ispElem) = 0;
  
  /**
  * @deprecated V5R26 CATIGSMUseExtrapol#GetLimitType
  * <p>This method is deprecated because the model has changed to enable to set several boundaries.</p>
  * <p><b>Migration instructions</b>: use the signature that uses an integer as the first argument.</p>
 ...
 virtual    HRESULT GetLimitType(const int & iPosition, CATGSMExtrapolLimitType & oLimitType) = 0;
  ...
  /**
  * @deprecated V5R26 CATIGSMUseExtrapol#SetLimitType
  * <p>This method is deprecated because the model has changed to enable to set several boundaries.</p>
  * <p><b>Migration instructions</b>: use the signature that uses an integer as the first argument.</p>
 ...
 /**
    ...
    *      Limit type of extrapolation (CATGSMLengthLimit or CATGSMUpToElementLimit)
    */ 
 virtual    HRESULT SetLimitType(const int & iPosition, CATGSMExtrapolLimitType iLimitType) = 0;
  
  /**
  * @deprecated V5R26 CATIGSMUseExtrapol#GetElemUntil
  * <p>This method is deprecated because the model has changed to enable to set several boundaries.</p>
  * <p><b>Migration instructions</b>: use the signature that uses an integer as the first argument.</p>
  * Example: "GetElemUntil(oElem)" should be replaced with "GetElemUntil(1, oElem)".
  */ 
 virtual    HRESULT GetElemUntil(CATIMmiMechanicalFeature_var & oElem) = 0;
 ...
 /**
    ...
    */ 
 virtual    HRESULT GetElemUntil(const int & iPosition, CATIMmiMechanicalFeature_var & oElem) = 0;
  
  /**
  * @deprecated V5R26 CATIGSMUseExtrapol#SetElemUntil
  * <p>This method is deprecated because the model has changed to enable to set several boundaries.</p>
  * <p><b>Migration instructions</b>: use the signature that uses an integer as the first argument.</p>
  * Example: "SetElemUntil(iElem)" should be replaced with "SetElemUntil(1, iElem)".
  */ 
 virtual    HRESULT SetElemUntil(const CATIMmiMechanicalFeature_var iElem) = 0;
 ...
 /**
    ...
    *      surface or volume specifying the extrapolation limit 
    */ 
 virtual    HRESULT SetElemUntil(const int & iPosition, const CATIMmiMechanicalFeature_var ispElem) = 0;
  
  /**
  * @deprecated V5R26 CATIGSMUseExtrapol#GetLength
  * <p>This method is deprecated because the model has changed to enable to set several boundaries.</p>
  * <p><b>Migration instructions</b>: use the signature that uses an integer as the first argument.</p>
 ...
 /**
    ...
    *   @see CATICkeParm
 */ 
 virtual    HRESULT GetLength(const int & iPosition, CATICkeParm_var & oLength) = 0;
  
  /**
  * @deprecated V5R26 CATIGSMUseExtrapol#SetLength
  * <p>This method is deprecated because the model has changed to enable to set several boundaries.</p>
  * <p><b>Migration instructions</b>: use the signature that uses an integer as the first argument.</p>
 ...
 /**
    ...
    *      Length
    */ 
 virtual    HRESULT SetLength(const int & iPosition, double iLength) = 0;
 ...
 */ 
 virtual    HRESULT SetLength(const int & iPosition, const CATICkeParm_var ispLength) = 0;
  ...
  /**
  * @deprecated V5R26 CATIGSMUseExtrapol#GetContinuityType
  * <p>This method is deprecated because the model has changed to enable to set several boundaries.</p>
  * <p><b>Migration instructions</b>: use the signature that uses an integer as the first argument.</p>
 ...
 */ 
 virtual    HRESULT GetContinuityType(const int & iPosition, CATGSMExtrapolContinuityType & oContinuityType) = 0;
  ...
  /**
  * @deprecated V5R26 CATIGSMUseExtrapol#SetContinuityType
  * <p>This method is deprecated because the model has changed to enable to set several boundaries.</p>
  * <p><b>Migration instructions</b>: use the signature that uses an integer as the first argument.</p>
 ...
 *   @see CATGSMExtrapolContinuityType
    */ 
 virtual    HRESULT SetContinuityType(const int & iPosition, CATGSMExtrapolContinuityType iContinuityType) = 0;
 ...
 *   @see CATGSMExtrapolBorderType
  ...
  */
 virtual HRESULT GetInternalEdgesElements( CATLISTV(CATIMmiMechanicalFeature_var) & oInternalElements) =0;
  ...
  */
 virtual HRESULT AddInternalEdgesElement(CATIMmiMechanicalFeature_var & InternalElement) = 0;
 ...
 */
 virtual HRESULT RemoveInternalEdgesElement(const CATIMmiMechanicalFeature_var iElem) = 0;
...
CATDeclareHandler (CATIGSMUseExtrapol, CATBaseUnknown);
#endif // CATIGSMUseExtrapol_H
