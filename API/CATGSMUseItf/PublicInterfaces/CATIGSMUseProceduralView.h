#ifndef CATIGSMUseProceduralView_H
#define CATIGSMUseProceduralView_H
...
//
//
// CATIGSMUseProceduralView.h
// Define the CATIGSMUseProceduralView interface
//
...
extern ExportedByCATGSMUseItf IID IID_CATIGSMUseProceduralView ;
#else
extern "C" const IID IID_CATIGSMUseProceduralView ;
#endif
 ...
 *
 * <li> Update 
 * <br> once aggregated, the feature has to be update (Update method of CATIMmiMechanicalFeature) 
 * </li> 
 *
 ...
 *  </pre>
 * 
 *  @see CATIGSMUseTool , CATIMechanicalRootFactory, CATMmrLinearBodyServices , CATIMmiMechanicalFeature  
 */
class ExportedByCATGSMUseItf CATIGSMUseProceduralView : public CATBaseUnknown
{
  ...
  public:
     ...
     */
      virtual HRESULT InsertInProceduralView(const CATIMmiMechanicalFeature_var& father=NULL_var,const CATBoolean bSetAsCurrent=TRUE,
		  const CATIMmiMechanicalFeature_var& BeforeFeature=NULL_var) = 0;

};

//------------------------------------------------------------------

CATDeclareHandler( CATIGSMUseProceduralView, CATBaseUnknown );
