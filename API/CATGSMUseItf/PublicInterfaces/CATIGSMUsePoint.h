/* -*-c++-*- */
#ifndef CATIGSMUsePoint_H
#define CATIGSMUsePoint_H
...
extern ExportedByCATGSMUseItf IID  IID_CATIGSMUsePoint;
#else
extern "C" const IID IID_CATIGSMUsePoint;
#endif
/**
...
class ExportedByCATGSMUseItf CATIGSMUsePoint : public CATBaseUnknown
{
   CATDeclareInterface;
public: 
 ...
 virtual HRESULT GetPointType(int & oT) = 0;
    ...
    /**
      ...
      * @see CATIGSMUseFactory#CreatePointType
      */
...
CATDeclareHandler (CATIGSMUsePoint, CATBaseUnknown);
#endif
