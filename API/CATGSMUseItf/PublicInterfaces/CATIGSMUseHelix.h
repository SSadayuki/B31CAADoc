/* -*-c++-*- */
#ifndef CATIGSMUseHelix_H
#define CATIGSMUseHelix_H
...
extern ExportedByCATGSMUseItf IID  IID_CATIGSMUseHelix;
#else
extern "C" const IID IID_CATIGSMUseHelix;
#endif
/**
 ...
 * @see CATIGSMUseFactory#CreateHelix
 */
class ExportedByCATGSMUseItf CATIGSMUseHelix : public CATBaseUnknown
{
   CATDeclareInterface;
public: 
    /**
     ...
     *      The helix axis
     */
   virtual    CATIMmiMechanicalFeature_var        GetAxis() = 0;
    /**
   ...
   virtual    HRESULT    GetInvertAxis(CATBoolean & oInvert) = 0;
     ...
     *     The starting point
     */
   virtual    CATIMmiMechanicalFeature_var GetStartingPoint()= 0;
    /**
     * Gets the profile of the helix.
     *   @return
     *     The profile
     */
   virtual    CATIMmiMechanicalFeature_var GetProfile()= 0;
    /**
 ...
 virtual HRESULT GetPitchLawType(enum CATGSMBasicLawType & oType) = 0;
   ...
   virtual    HRESULT SetAxis(const CATIMmiMechanicalFeature_var iElem1) = 0;
     ...
     *      New starting point.
     */
   virtual    HRESULT SetStartingPoint(const CATIMmiMechanicalFeature_var iElem1) = 0;
    /**
     * Sets the profile.
     *   @param iElem1
     *      New profile.
     ...
     */
   virtual    HRESULT SetProfile(const CATIMmiMechanicalFeature_var iElem1) = 0;
    /**
...
CATDeclareHandler (CATIGSMUseHelix, CATBaseUnknown);
#endif // CATIGSMUseHelix_H
