/* -*-c++-*- */
#ifndef CATIGSMUseLineBiTangent_H
#define CATIGSMUseLineBiTangent_H
// 
...
extern ExportedByCATGSMUseItf IID  IID_CATIGSMUseLineBiTangent;
#else
extern "C" const IID IID_CATIGSMUseLineBiTangent;
#endif
 ...
 * @see CATIGSMUseLine
 * @see CATIGSMUseFactory#CreateLineBiTangent
 */
class ExportedByCATGSMUseItf CATIGSMUseLineBiTangent : public CATBaseUnknown
{
  CATDeclareInterface;
public: 
  ...
  */
  virtual HRESULT GetFirstTangentElement(CATIMmiMechanicalFeature_var& Element1) = 0;
  /**
   * Set the first curve to which the line will be tangent.
   */
  virtual HRESULT SetFirstTangentElement(const CATIMmiMechanicalFeature_var Element1) = 0;
  /**
   * Get the second element to which the line is tangent (curve or point).
   */
  virtual HRESULT GetSecondTangentElement(CATIMmiMechanicalFeature_var& Element2) = 0;
  /**
   * Set the second element to which the line will be tangent (curve or point).
   */
  virtual HRESULT SetSecondTangentElement(const CATIMmiMechanicalFeature_var Element2) = 0;
  /**
   * Get the support surface. The line lies on it.
   */
  virtual HRESULT GetSupport(CATIMmiMechanicalFeature_var& Support) = 0;
  /**
   * Set the support surface. The line will lie on it.
   */
  virtual HRESULT SetSupport(const CATIMmiMechanicalFeature_var Support) = 0;
   /**
...
CATDeclareHandler (CATIGSMUseLineBiTangent, CATBaseUnknown);
#endif
