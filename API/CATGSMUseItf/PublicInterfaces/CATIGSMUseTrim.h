/* -*-c++-*- */
#ifndef CATIGSMUseTrim_H
#define CATIGSMUseTrim_H
// 
...
extern ExportedByCATGSMUseItf IID  IID_CATIGSMUseTrim;
#else
extern "C" const IID IID_CATIGSMUseTrim;
#endif
 ...
 * @see CATIGSMUseFactory#CreateTrim
 */
class ExportedByCATGSMUseItf CATIGSMUseTrim : public CATBaseUnknown
{
   CATDeclareInterface;
...
public: 
  ...
  /**
    * @deprecated V5R17 CATIGSMUseTrim#GetElem
 ...
 virtual    HRESULT GetFirstElem(CATIMmiMechanicalFeature_var & oElem) = 0;
  ...
  /**
    * @deprecated V5R17 CATIGSMUseTrim#SetElem
 ...
 virtual    HRESULT SetSecondElem(const CATIMmiMechanicalFeature_var iElem) = 0;
  ...
  /**
    * @deprecated V5R17 CATIGSMUseTrim#GetNextOrientation
 ...
 virtual    HRESULT GetFirstOrientation(CATGSMOrientation & oOrientation) = 0;
   ...
   /**
    * @deprecated V5R17 CATIGSMUseTrim#SetNextOrientation(1)
 ...
 virtual    HRESULT SetFirstOrientation(CATGSMOrientation iOrientation) = 0;
  ...
  /**
    * @deprecated V5R17 CATIGSMUseTrim#GetPreviousOrientation
 ...
 virtual    HRESULT GetSecondOrientation(CATGSMOrientation & oOrientation) = 0;
  ...
  /**
    * @deprecated V5R17 CATIGSMUseTrim#SetPreviousOrientation(1)
 ...
 virtual    HRESULT SetSecondOrientation(CATGSMOrientation iOrientation) = 0;
  ...
  /**
    * @deprecated V5R17 CATIGSMUseTrim#InvertNextOrientation
    * Inverts the first orientation used to compute the trim. 
    */
 virtual    HRESULT InvertFirstOrientation() = 0;

  /**
    * @deprecated V5R17 CATIGSMUseTrim#InvertPreviousOrientation
 ...
 virtual    HRESULT GetIntersectionComputation(CATBoolean & oMode) = 0;
  /**
    ...
    *       Intersection
    */
 virtual    HRESULT GetIntersection(CATIMmiMechanicalFeature_var & oElem) = 0;
 ...
 */
 virtual    HRESULT GetElem(CATIMmiMechanicalFeature_var & oElem, const int iRank) = 0;
 ...
 */ 
 virtual    HRESULT GetElems(CATLISTV(CATIMmiMechanicalFeature_var) & oElems) = 0;
 ...
 *      Index of one of the trimmed features  
 */
 virtual    HRESULT SetElem(const CATIMmiMechanicalFeature_var iElem, const int iRank) = 0;
 ...
 *      feature to trim
 */
 virtual    HRESULT AddElem(const CATIMmiMechanicalFeature_var & iElem) = 0;
 ...
 *   the element. 
 */ 
 virtual HRESULT InsertElem(const CATIMmiMechanicalFeature_var iElem, const int iPosition) = 0;
 ...
 */
 virtual    HRESULT SetNumberOfIntersections( const CATIMmiMechanicalFeature_var iElem, const int iNbIntersections) = 0;
 ...
 *      Number of intersections
 */
 virtual    HRESULT GetNumberOfIntersections( const CATIMmiMechanicalFeature_var iElem, int& oNbIntersections) =0;
...
CATDeclareHandler (CATIGSMUseTrim, CATBaseUnknown);
#endif // CATIGSMUseTrim_H
