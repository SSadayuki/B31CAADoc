#ifndef CATTopEdgePropagation_H
#define CATTopEdgePropagation_H
...
class ExportedByCATTopologicalObjects CATTopEdgePropagation : public CATTopOperator
{
  

  CATCGMVirtualDeclareClass(CATTopEdgePropagation);
protected:

  /**
  * @nodoc
  * Constructor. Do not use. Use <tt>CATCreateTopEdgePropagation</tt> to create an
  * <tt>CATTopEdgePropagation</tt>.
  */
  CATTopEdgePropagation ( CATGeoFactory * iFactory , 
                          CATTopData    * iTopData );
...
public:
  ...
  * </dl>
  */
  virtual void SetTolerance ( const CATResolutionType iContinuity , const double & iTolerance ) = 0;
  ...
  * </dl>
  */
  virtual void GetDiagnoses ( CATTopEdgePropagationDiagnosis oDiagnoses [2]         ,
  ...
  * This body can be made either of shells or of wires.
  ...
  * @return
  */
  ExportedByCATTopologicalObjects CATTopEdgePropagation * 
    CATCreateTopEdgePropagation ( CATGeoFactory * iFactory     , 
                                  CATTopData    * iTopData     , 
                                  CATBody       * iBody        , 
