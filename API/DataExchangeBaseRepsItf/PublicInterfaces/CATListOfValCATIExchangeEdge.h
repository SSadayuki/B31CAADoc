...
/************************************************************************/
/* Fichier CATListOfValCatIExchangeEdge.h                               */
/*      Classe necessaire a l'utilisation du type                       */
/*      CATLISTV(CATIExchangeEdge).                                     */
...
#ifndef _H_CAT_LIST_OF_EXCHANGE_EDGE

#include "DataExchangeBaseRepsItfCPP.h"

class CATIExchangeEdge;
...
CATLISTV_DECLARE( CATIExchangeEdge_var )

#define _H_CAT_LIST_OF_EXCHANGE_EDGE
#endif
