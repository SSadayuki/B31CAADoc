...
LINK_WITH=$(LINK_WITH_FOR_IID) JS0GROUP YN000MAT NS0SI18N DI0PANV2 \
			...
			KnowledgeItf CATCafAutomation YN000FUN YP00IMPL MecModItfCPP CATLiteralFeatures CK0FEAT CK0AUTO CATInfInterfaces
			

INCLUDED_MODULES = CATLifInspector CATLifLibrary CATLifExpressions CATLifParser  CATLifRelations CATLifDesignTable CATLifBehaviour \
									 CATLifList CATLifFunction CATLifServices \
									 CATLifTechFeature CATLifVBParser
