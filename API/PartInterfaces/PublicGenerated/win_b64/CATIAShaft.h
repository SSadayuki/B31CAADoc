...
extern ExportedByPartPubIDL IID IID_CATIAShaft;

class ExportedByPartPubIDL CATIAShaft : public CATIARevolution
{
    CATDeclareInterface;
...
CATDeclareHandler(CATIAShaft, CATIARevolution);
