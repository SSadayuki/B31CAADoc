#ifndef CATTopExtrapolWireOpe_h
#define CATTopExtrapolWireOpe_h
...
class ExportedByAdvTopoSketch CATTopExtrapolWireOpe : public CATTopOperator
{

  CATCGMVirtualDeclareClass(CATTopExtrapolWireOpe);
public:
   /** @nodoc */
  CATTopExtrapolWireOpe(CATGeoFactory * iFacto,CATTopData * iData);
   /** @nodoc */
  virtual ~CATTopExtrapolWireOpe();
