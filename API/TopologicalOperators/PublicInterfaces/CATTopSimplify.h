#ifndef CATTopSimplify_h
#define CATTopSimplify_h
...
* </ul>
*/
class ExportedByBOTOPOPE CATTopSimplify : public CATTopOperator
{
  CATCGMVirtualDeclareClass(CATTopSimplify);
public:

   //  Destructor
  virtual ~CATTopSimplify();
...
protected:
  ...
  /** @nodoc */
  CATTopSimplify ( CATGeoFactory * iFactory        ,
	               CATTopData *    iTopData        ,
...
ExportedByBOTOPOPE CATTopSimplify * CATCreateTopSimplify ( CATGeoFactory *     iFactory        ,
														   CATTopData *        iData           ,
                                                           CATBody *           iBodyToSimplify );
