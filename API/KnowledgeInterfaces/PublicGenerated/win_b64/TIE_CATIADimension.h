#ifndef __TIE_CATIADimension
#define __TIE_CATIADimension
...
/* To link an implementation with the interface CATIADimension */
#define declare_TIE_CATIADimension(classe) \
 \
 \
class TIECATIADimension##classe : public CATIADimension \
{ \
   private: \
      CATDeclareCommonTIEMembers \
   public: \
      CATDeclareTIEMethods(CATIADimension, classe) \
...
#define ENVTIEdeclare_CATIADimension(ENVTIEName,ENVTIETypeLetter,ENVTIELetter) \
virtual HRESULT __stdcall get_Unit(CATIAUnit *& oUnit); \
virtual HRESULT __stdcall ValueAsString2(CATLONG iNbDecimals, CAT_VARIANT_BOOL iShowTrailingZeros, CATBSTR & oValue); \
virtual HRESULT __stdcall get_Value(double & oValue); \
virtual HRESULT __stdcall put_Value(double iValue); \
...
#define ENVTIEdefine_CATIADimension(ENVTIEName,ENVTIETypeLetter,ENVTIELetter) \
HRESULT __stdcall  ENVTIEName::get_Unit(CATIAUnit *& oUnit) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)get_Unit(oUnit)); \
} \
HRESULT __stdcall  ENVTIEName::ValueAsString2(CATLONG iNbDecimals, CAT_VARIANT_BOOL iShowTrailingZeros, CATBSTR & oValue) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)ValueAsString2(iNbDecimals,iShowTrailingZeros,oValue)); \
} \
HRESULT __stdcall  ENVTIEName::get_Value(double & oValue) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)get_Value(oValue)); \
} \
HRESULT __stdcall  ENVTIEName::put_Value(double iValue) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)put_Value(iValue)); \
} \
HRESULT __stdcall  ENVTIEName::get_RangeMin(double & oRangeMin) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)get_RangeMin(oRangeMin)); \
} \
HRESULT __stdcall  ENVTIEName::put_RangeMin(double iRangeMin) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)put_RangeMin(iRangeMin)); \
} \
HRESULT __stdcall  ENVTIEName::get_RangeMax(double & oRangeMax) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)get_RangeMax(oRangeMax)); \
} \
HRESULT __stdcall  ENVTIEName::put_RangeMax(double iRangeMax) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)put_RangeMax(iRangeMax)); \
} \
HRESULT __stdcall  ENVTIEName::get_RangeMinValidity(CATLONG & oRangeMinValidity) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)get_RangeMinValidity(oRangeMinValidity)); \
} \
HRESULT __stdcall  ENVTIEName::put_RangeMinValidity(CATLONG iRangeMinValidity) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)put_RangeMinValidity(iRangeMinValidity)); \
} \
HRESULT __stdcall  ENVTIEName::get_RangeMaxValidity(CATLONG & oRangeMaxValidity) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)get_RangeMaxValidity(oRangeMaxValidity)); \
} \
HRESULT __stdcall  ENVTIEName::put_RangeMaxValidity(CATLONG iRangeMaxValidity) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)put_RangeMaxValidity(iRangeMaxValidity)); \
} \
HRESULT __stdcall  ENVTIEName::get_MinimumTolerance(double & oValue) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)get_MinimumTolerance(oValue)); \
} \
HRESULT __stdcall  ENVTIEName::put_MinimumTolerance(double iValue) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)put_MinimumTolerance(iValue)); \
} \
HRESULT __stdcall  ENVTIEName::get_MaximumTolerance(double & oValue) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)get_MaximumTolerance(oValue)); \
} \
HRESULT __stdcall  ENVTIEName::put_MaximumTolerance(double iValue) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)put_MaximumTolerance(iValue)); \
} \
HRESULT __stdcall  ENVTIEName::GetEnumerateValues(CATSafeArrayVariant & oSafeArray) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)GetEnumerateValues(oSafeArray)); \
} \
HRESULT __stdcall  ENVTIEName::GetEnumerateValuesSize(CATLONG & oValue) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)GetEnumerateValuesSize(oValue)); \
} \
HRESULT __stdcall  ENVTIEName::SetEnumerateValues(const CATSafeArrayVariant & iSafeArray) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)SetEnumerateValues(iSafeArray)); \
} \
HRESULT __stdcall  ENVTIEName::SuppressEnumerateValues() \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)SuppressEnumerateValues()); \
} \
HRESULT __stdcall  ENVTIEName::IsEqualTo(double iValueToCompare, CAT_VARIANT_BOOL & oIsEqual) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)IsEqualTo(iValueToCompare,oIsEqual)); \
} \
HRESULT __stdcall  ENVTIEName::ValuateFromString(const CATBSTR & iValue) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)ValuateFromString(iValue)); \
} \
HRESULT __stdcall  ENVTIEName::ValueAsString(CATBSTR & oValue) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)ValueAsString(oValue)); \
} \
HRESULT __stdcall  ENVTIEName::get_OptionalRelation(CATIARelation *& oRelation) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)get_OptionalRelation(oRelation)); \
} \
HRESULT __stdcall  ENVTIEName::get_ReadOnly(CAT_VARIANT_BOOL & oReadOnly) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)get_ReadOnly(oReadOnly)); \
} \
HRESULT __stdcall  ENVTIEName::Rename(const CATBSTR & iName) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)Rename(iName)); \
} \
HRESULT __stdcall  ENVTIEName::get_Comment(CATBSTR & oComment) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)get_Comment(oComment)); \
} \
HRESULT __stdcall  ENVTIEName::put_Comment(const CATBSTR & iComment) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)put_Comment(iComment)); \
} \
HRESULT __stdcall  ENVTIEName::get_Hidden(CAT_VARIANT_BOOL & oHidden) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)get_Hidden(oHidden)); \
} \
HRESULT __stdcall  ENVTIEName::put_Hidden(CAT_VARIANT_BOOL iHidden) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)put_Hidden(iHidden)); \
} \
HRESULT __stdcall  ENVTIEName::get_UserAccessMode(CATLONG & oUserAccessMode) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)get_UserAccessMode(oUserAccessMode)); \
} \
HRESULT __stdcall  ENVTIEName::get_Context(CATIABase *& oContext) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)get_Context(oContext)); \
} \
HRESULT __stdcall  ENVTIEName::get_Renamed(CAT_VARIANT_BOOL & oRenamed) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)get_Renamed(oRenamed)); \
} \
HRESULT __stdcall  ENVTIEName::get_IsTrueParameter(CAT_VARIANT_BOOL & oIsTrueParameter) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)get_IsTrueParameter(oIsTrueParameter)); \
} \
HRESULT  __stdcall  ENVTIEName::get_Application(CATIAApplication *& oApplication) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)get_Application(oApplication)); \
} \
HRESULT  __stdcall  ENVTIEName::get_Parent(CATBaseDispatch *& oParent) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)get_Parent(oParent)); \
} \
HRESULT  __stdcall  ENVTIEName::get_Name(CATBSTR & oNameBSTR) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)get_Name(oNameBSTR)); \
} \
HRESULT  __stdcall  ENVTIEName::put_Name(const CATBSTR & iNameBSTR) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)put_Name(iNameBSTR)); \
} \
HRESULT  __stdcall  ENVTIEName::GetItem(const CATBSTR & IDName, CATBaseDispatch *& RealObj) \
{ \
return (ENVTIECALL(CATIADimension,ENVTIETypeLetter,ENVTIELetter)GetItem(IDName,RealObj)); \
} \


/* Name of the TIE class */
#define class_TIE_CATIADimension(classe)    TIECATIADimension##classe


/* Common methods inside a TIE */
#define common_TIE_CATIADimension(classe) \
 \
 \
/* Static initialization */ \
CATDefineCommonTIEMembers(CATIADimension, classe) \
 \
 \
CATImplementTIEMethods(CATIADimension, classe) \
CATImplementIUnknownMethodsForCATBaseUnknownTIE(CATIADimension, classe, 2) \
CATImplementIDispatchMethodsForCATBaseUnknownTIE(CATIADimension, classe) \
CATImplementCATBaseUnknownMethodsForTIE(CATIADimension, classe) \
 \
HRESULT __stdcall  TIECATIADimension##classe::get_Unit(CATIAUnit *& oUnit) \
{ \
...
HRESULT __stdcall  TIECATIADimension##classe::ValueAsString2(CATLONG iNbDecimals, CAT_VARIANT_BOOL iShowTrailingZeros, CATBSTR & oValue) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT __stdcall  TIECATIADimension##classe::get_Value(double & oValue) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT __stdcall  TIECATIADimension##classe::put_Value(double iValue) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT __stdcall  TIECATIADimension##classe::get_RangeMin(double & oRangeMin) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT __stdcall  TIECATIADimension##classe::put_RangeMin(double iRangeMin) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT __stdcall  TIECATIADimension##classe::get_RangeMax(double & oRangeMax) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT __stdcall  TIECATIADimension##classe::put_RangeMax(double iRangeMax) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT __stdcall  TIECATIADimension##classe::get_RangeMinValidity(CATLONG & oRangeMinValidity) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT __stdcall  TIECATIADimension##classe::put_RangeMinValidity(CATLONG iRangeMinValidity) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT __stdcall  TIECATIADimension##classe::get_RangeMaxValidity(CATLONG & oRangeMaxValidity) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT __stdcall  TIECATIADimension##classe::put_RangeMaxValidity(CATLONG iRangeMaxValidity) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT __stdcall  TIECATIADimension##classe::get_MinimumTolerance(double & oValue) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT __stdcall  TIECATIADimension##classe::put_MinimumTolerance(double iValue) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT __stdcall  TIECATIADimension##classe::get_MaximumTolerance(double & oValue) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT __stdcall  TIECATIADimension##classe::put_MaximumTolerance(double iValue) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT __stdcall  TIECATIADimension##classe::GetEnumerateValues(CATSafeArrayVariant & oSafeArray) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT __stdcall  TIECATIADimension##classe::GetEnumerateValuesSize(CATLONG & oValue) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT __stdcall  TIECATIADimension##classe::SetEnumerateValues(const CATSafeArrayVariant & iSafeArray) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT __stdcall  TIECATIADimension##classe::SuppressEnumerateValues() \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT __stdcall  TIECATIADimension##classe::IsEqualTo(double iValueToCompare, CAT_VARIANT_BOOL & oIsEqual) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT __stdcall  TIECATIADimension##classe::ValuateFromString(const CATBSTR & iValue) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT __stdcall  TIECATIADimension##classe::ValueAsString(CATBSTR & oValue) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT __stdcall  TIECATIADimension##classe::get_OptionalRelation(CATIARelation *& oRelation) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT __stdcall  TIECATIADimension##classe::get_ReadOnly(CAT_VARIANT_BOOL & oReadOnly) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT __stdcall  TIECATIADimension##classe::Rename(const CATBSTR & iName) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT __stdcall  TIECATIADimension##classe::get_Comment(CATBSTR & oComment) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT __stdcall  TIECATIADimension##classe::put_Comment(const CATBSTR & iComment) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT __stdcall  TIECATIADimension##classe::get_Hidden(CAT_VARIANT_BOOL & oHidden) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT __stdcall  TIECATIADimension##classe::put_Hidden(CAT_VARIANT_BOOL iHidden) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT __stdcall  TIECATIADimension##classe::get_UserAccessMode(CATLONG & oUserAccessMode) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT __stdcall  TIECATIADimension##classe::get_Context(CATIABase *& oContext) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT __stdcall  TIECATIADimension##classe::get_Renamed(CAT_VARIANT_BOOL & oRenamed) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT __stdcall  TIECATIADimension##classe::get_IsTrueParameter(CAT_VARIANT_BOOL & oIsTrueParameter) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT  __stdcall  TIECATIADimension##classe::get_Application(CATIAApplication *& oApplication) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT  __stdcall  TIECATIADimension##classe::get_Parent(CATBaseDispatch *& oParent) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT  __stdcall  TIECATIADimension##classe::get_Name(CATBSTR & oNameBSTR) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT  __stdcall  TIECATIADimension##classe::put_Name(const CATBSTR & iNameBSTR) \
{ \
   CATICallTrac2 *_Trac2; \
...
HRESULT  __stdcall  TIECATIADimension##classe::GetItem(const CATBSTR & IDName, CATBaseDispatch *& RealObj) \
{ \
   CATICallTrac2 *_Trac2; \
...
#define TIE_CATIADimension(classe) \
 \
 \
declare_TIE_CATIADimension(classe) \
 \
 \
CATMetaClass * __stdcall TIECATIADimension##classe::MetaObject() \
{ \
   if (!meta_object) \
   { \
      meta_object=new CATMetaClass(&IID_CATIADimension,"CATIADimension",CATIADimension::MetaObject(),classe::MetaObject(),TIE); \
   } \
   return(meta_object); \
} \
 \
 \
common_TIE_CATIADimension(classe) \
 \
 \
/* creator function of the interface */ \
/* encapsulate the new */ \
CATImplementTIECreation(CATIADimension, classe) \
 \
/* to put information into the dictionary */ \
static CATFillDictionary DicCATIADimension##classe(classe::MetaObject(),CATIADimension::MetaObject(),(void *)CreateTIECATIADimension##classe)



/* Macro used to link an implementation with an interface */
/* This TIE is chained on the implementation object */
#define TIEchain_CATIADimension(classe) \
 \
 \
declare_TIE_CATIADimension(classe) \
 \
...
{ \
   if (!meta_object) \
   { \
      meta_object=new CATMetaClass(&IID_CATIADimension,"CATIADimension",CATIADimension::MetaObject(),classe::MetaObject(),TIEchain); \
   } \
   return(meta_object); \
} \
 \
...
/* creator function of the interface */ \
/* encapsulate the new */ \
CATImplementTIEchainCreation(CATIADimension, classe) \
 \
/* to put information into the dictionary */ \
static CATFillDictionary DicCATIADimension##classe(classe::MetaObject(),CATIADimension::MetaObject(),(void *)CreateTIECATIADimension##classe)
...
#define BOA_CATIADimension(classe) TIE_CATIADimension(classe)
#else
#define BOA_CATIADimension(classe) CATImplementBOA(CATIADimension, classe)
#endif
