...
#ifndef _CATListOfCATIVpmAFLAffectedObject_H_
#define _CATListOfCATIVpmAFLAffectedObject_H_
...
/**
 * @collection CATListOfCATIVpmAFLAffectedObject
 * Collection class for CATIVpmAFLAffectedObject_var.
...
CATLISTV_DECLARE(CATIVpmAFLAffectedObject_var)
typedef CATLISTV(CATIVpmAFLAffectedObject_var) CATListOfCATIVpmAFLAffectedObject;
