...
//=============================================================================
// September 99 Creation                                            C. Cressend
// November 01  Modification                                            S. Dami
//              Insert CAA2 documentation                                 
//=============================================================================

#ifndef _CATListOfCATIVpmAFLResp_H_
#define _CATListOfCATIVpmAFLResp_H_
...
#include "CATIVpmAFLResp.h"

#include "CATLISTV_Clean.h"

/**
 * @collection CATListOfCATIVpmAFLResp
 * Collection class for CATIVpmAFLResp_var.
...
CATLISTV_DECLARE(CATIVpmAFLResp_var)
typedef CATLISTV(CATIVpmAFLResp_var) CATListOfCATIVpmAFLResp;
