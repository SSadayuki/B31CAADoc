...
//=============================================================================
#ifndef ENOVISaveEvent_H
#define ENOVISaveEvent_H
...
extern ExportedByGUIDVPMInterfaces IID IID_ENOVISaveEvent;
#else
extern "C" const IID IID_ENOVISaveEvent;
#endif
 ...
 */
/**
 * Class to be implemented by a client who wants to subscribe to event Save which may be raised .
 * CallBack Interface : when the publisher raises an event Save, the subscriber is called back on methods
 * of this interface.
 * <br><b>Role</b>: the Subscriber gives a pointer on the implementation of this interface for subscription.
 */
class ExportedByGUIDVPMInterfaces ENOVISaveEvent : public CATBaseUnknown
{
    CATDeclareInterface;
...
//Save event
	 /**
	  *  Method called before a Save action is done .
	  * <br><b>Role</b>: to call back clients which subscribed to Save event - step before -
	  *  @param iRaisedEvent
	  *   the instance of event which is currently raised.
	  *  @param ioNotifyReturnCode
	  ...
	  *   @see ENOVIEvent
	  */
    virtual HRESULT onBeforeSave(const ENOVIEvent_var& iRaisedEvent,
				 HRESULT& ioNotifyReturnCode) = 0 ; 

	 /**
	  *  Method called after a Save action was done.
	  * <br><b>Role</b>: to call back clients which subscribed to Save event -step after -
	  *  @param iRaisedEvent
	  *   the instance of event which is currently raised.
	  *  @param ioNotifyReturnCode
	  *   the status to be returned by the method : <br>
	  ...
	  *   @see ENOVIEvent
	  */
    virtual HRESULT onAfterSave(const ENOVIEvent_var& iRaisedEvent,
				HRESULT& ioNotifyReturnCode) = 0 ;
...
// Handler definition
//-----------------------------------------------------------------
CATDeclareHandler(ENOVISaveEvent, CATBaseUnknown);
