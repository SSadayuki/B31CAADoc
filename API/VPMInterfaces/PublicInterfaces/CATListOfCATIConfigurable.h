...
#ifndef CATListOfCATIConfigurable_h
#define CATListOfCATIConfigurable_h
...
/**
 * @collection CATListOfCATIConfigurable_var
 * Collection class for CATIConfigurable_var.
...
CATLISTV_DECLARE(CATIConfigurable_var)
typedef CATLISTV(CATIConfigurable_var) CATListOfCATIConfigurable_var;
