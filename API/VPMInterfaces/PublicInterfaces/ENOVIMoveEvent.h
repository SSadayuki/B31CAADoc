...
//=============================================================================
#ifndef ENOVIMoveEvent_H
#define ENOVIMoveEvent_H
...
extern ExportedByGUIDVPMInterfaces IID IID_ENOVIMoveEvent;
#else
extern "C" const IID IID_ENOVIMoveEvent;
#endif
 ...
 */
/**
 * Class to be implemented by a client who wants to subscribe to event Move which may be raised .
 * CallBack Interface : when the publisher raises an event Move, the subscriber is called back on methods
 * of this interface.
 * <br><b>Role</b>: the Subscriber gives a pointer on the implementation of this interface for subscription.
 */
class ExportedByGUIDVPMInterfaces ENOVIMoveEvent : public CATBaseUnknown
{
    CATDeclareInterface;
...
//Move event 
	 /**
	  *  Method called before a Move action is done .
	  * <br><b>Role</b>: to call back clients which subscribed to Move event - step before -
	  *  @param iRaisedEvent
	  *   the instance of event which is currently raised.
	  *  @param ioNotifyReturnCode
	  ...
	  *   @see ENOVIEvent
	  */
    virtual HRESULT onBeforeMove (const ENOVIEvent_var& iRaisedEvent, 
				  HRESULT& ioNotifyReturnCode) = 0 ; 
	 /**
	  *  Method called after a Move action was done.
	  * <br><b>Role</b>: to call back clients which subscribed to Move event -step after -
	  *  @param iRaisedEvent
	  *   the instance of event which is currently raised.
	  *  @param ioNotifyReturnCode
	  *   the status to be returned by the method : <br>
	  ...
	  *   @see ENOVIEvent
	  */
    virtual HRESULT onAfterMove (const ENOVIEvent_var& iRaisedEvent, 
				 HRESULT& ioNotifyReturnCode) = 0 ;
};
//-----------------------------------------------------------------
// Handler definition
//-----------------------------------------------------------------
CATDeclareHandler(ENOVIMoveEvent, CATBaseUnknown);
