...
#ifndef _CATListOfCATIVpmAFLSubscribePV_H_
#define _CATListOfCATIVpmAFLSubscribePV_H_
...
#include "CATIVpmAFLSubscribePV.h"

#include "CATLISTV_Clean.h"

/**
 * @collection CATListOfCATIVpmAFLSubscribePV
 * Collection class for CATIVpmAFLSubscribePV_var.
...
CATLISTV_DECLARE(CATIVpmAFLSubscribePV_var)
typedef CATLISTV(CATIVpmAFLSubscribePV_var) CATListOfCATIVpmAFLSubscribePV;
