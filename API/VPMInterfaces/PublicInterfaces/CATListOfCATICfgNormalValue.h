...
#ifndef _CATListOfCATICfgNormalValue_H_
#define _CATListOfCATICfgNormalValue_H_
...
/**
 * @collection CATListOfCATICfgNormalValue_var
 * Collection class for CATICfgNormalValue_var.
...
CATLISTV_DECLARE(CATICfgNormalValue_var)
typedef CATLISTV(CATICfgNormalValue_var) CATListOfCATICfgNormalValue_var;
