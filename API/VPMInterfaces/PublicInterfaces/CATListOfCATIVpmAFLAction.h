...
#ifndef _CATListOfCATIVpmAFLAction_H_
#define _CATListOfCATIVpmAFLAction_H_
...
/**
 * @collection CATListOfCATIVpmAFLAction
 * Collection class for CATIVpmAFLAction_var.
...
CATLISTV_DECLARE(CATIVpmAFLAction_var)
typedef CATLISTV(CATIVpmAFLAction_var) CATListOfCATIVpmAFLAction;
