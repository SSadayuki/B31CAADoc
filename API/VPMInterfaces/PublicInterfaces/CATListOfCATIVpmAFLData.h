...
#ifndef _CATListOfCATIVpmAFLData_H_
#define _CATListOfCATIVpmAFLData_H_
...
#include "CATIVpmAFLData.h"

#include "CATLISTV_Clean.h"

/**
 * @collection CATListOfCATIVpmAFLData
 * Collection class for CATIVpmAFLData_var.
...
CATLISTV_DECLARE(CATIVpmAFLData_var)
typedef CATLISTV(CATIVpmAFLData_var) CATListOfCATIVpmAFLData;
