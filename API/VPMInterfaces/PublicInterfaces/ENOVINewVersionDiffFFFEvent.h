...
//=============================================================================
#ifndef ENOVINewVersionDiffFFFEvent_H
#define ENOVINewVersionDiffFFFEvent_H
...
extern ExportedByGUIDVPMInterfaces IID IID_ENOVINewVersionDiffFFFEvent;
#else
extern "C" const IID IID_ENOVINewVersionDiffFFFEvent;
#endif
 ...
 */
/**
 * Class to be implemented by a client who wants to subscribe to event NewVersionDiffFFF which may be raised .
 ...
 */
//------------------------------------------------------------------
class ExportedByGUIDVPMInterfaces ENOVINewVersionDiffFFFEvent : public CATBaseUnknown
{
    CATDeclareInterface;
...
//NewVersionDiffFFF event
	  ...
	  *   @see ENOVIEvent
	  */
    virtual HRESULT onBeforeNewVersionDiffFFF(const ENOVIEvent_var& iRaisedEvent,
					      HRESULT& ioNotifyReturnCode) = 0 ; 
	  ...
	  *   @see ENOVIEvent
	  */
    virtual HRESULT onAfterNewVersionDiffFFF(const ENOVIEvent_var& iRaisedEvent,
					     HRESULT& ioNotifyReturnCode) = 0 ;
};
//-----------------------------------------------------------------
// Handler definition
//-----------------------------------------------------------------
CATDeclareHandler(ENOVINewVersionDiffFFFEvent, CATBaseUnknown);
