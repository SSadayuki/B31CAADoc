/* -*-c++-*- */
#ifndef CATLISTV_CATICatalogDescription_H_
#define CATLISTV_CATICatalogDescription_H_
...
/**
 * @collection CATLISTV(CATICatalogDescription_var)
 * Collection class for CATICatalogDescription interface handler.
...
CATLISTV_DECLARE( CATICatalogDescription_var )
