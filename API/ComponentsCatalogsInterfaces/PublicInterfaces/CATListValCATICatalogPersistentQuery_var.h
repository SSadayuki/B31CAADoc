/* -*-c++-*- */
#ifndef CATLISTV_CATICatalogPersistentQuery_H_
#define CATLISTV_CATICatalogPersistentQuery_H_
...
/**
 * @collection CATLISTV(CATICatalogPersistentQuery_var)
 * Collection class for CATICatalogPersistentQuery interface handler.
...
CATLISTV_DECLARE( CATICatalogPersistentQuery_var )
