 ...
 * @quickreview Q42 16:05:30 output path  english transation of Path de la sortie IR446369
 * @quickreview UWX 18:07:27 CastToCharPtr replaced with ConvertToChar
 */
/**
...
int main(int argc, char ** argv)
{
  ...
  CATMakePath (argv[3], name.ConvertToChar(), outputPath);
  ofstream outputFile;
