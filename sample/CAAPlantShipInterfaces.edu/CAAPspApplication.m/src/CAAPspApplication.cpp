/**
* @quickreview VD6 19:09:20 IR-516723 Modified DoSample(), CastToCharPtr() was depricated from CXR25, now using ConvertToChar API.
* @fullreview 
**/
//=============================================================================
...
int CAAPspApplication::DoSample(const CATUnicodeString &iFileToBeLoaded)
{
  ...
  CATTry 
  {
    ...
    if ( NULL != piResource )
    {
       ...
       CATUnicodeString DomainName = sDomain.ConvertToChar(); // IR-516723 Fix : CastToCharPtr() was depricated from CXR25, hence now using ConvertToChar API.
