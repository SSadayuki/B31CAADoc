         ...
         char** iArgv)   
{
	...
	int fA = 1; 
	for ( fA = 1; fA < listOfFacesA.Size()+1; fA++)
	{
	...
	int fB = 1;
	for ( fB = 1; fB < listOfFacesB.Size()+1; fB++)
	{
    ...
    //
	int k = 1;
    for ( k = 1; k < listOfFaces.Size()+1; k++)
    {
	  ...
	  int j = 1;
      for ( j = 1; j < originObjects.Size()+1; j++)
      {
    ...
    // ---------------------------------------------------
	int l = 1;
    for ( l = 1; l < absorbedFaces.Size()+1; l++)
    {
