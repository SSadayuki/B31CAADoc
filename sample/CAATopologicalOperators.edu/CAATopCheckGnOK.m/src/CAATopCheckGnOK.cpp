         ...
         char** iArgv)   // Path to the *.NCGM document that will contain the result of the main.
{
    ...
    // First cube
    //
    CATSolidCuboid * pSolidCubl = CATTopCreateSolidCuboid(piGeomFactory,
        &topdata,
        P[0],
        P[1],
        P[2],
    ...
    // Second cube 
    //
    CATSolidCuboid * pSolidCub2 = CATTopCreateSolidCuboid(piGeomFactory,
        &topdata,
        P[4],
        P[5],
        P[6],
...
#else
    ofstream verdictFile(pFileName1,ios::out) ;
    ofstream warningFile(pFileName2,ios::out) ;
#endif
...
#else
        ofstream filetowrite(pFileName,ios::out) ;
#endif
