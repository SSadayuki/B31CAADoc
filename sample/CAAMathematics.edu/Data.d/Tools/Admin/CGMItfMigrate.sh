...
migr_IdentityCard_h()
{
  awk '\
    ...
    (num_file == 2) \
    {
      ...
      else
      {
        ...
        if (comp == "")
        {
          ...
          if (! with_SPAOperators)
            with_SPAOperators = fw == "GMModelCmpInterfaces";
        }
        else
        {
          ...
          if (! add_SPAOperators)
            add_SPAOperators = index(comp, "SPA_Foundation") > 0;
          if (! add_GMPolyhedralOp)
            add_GMPolyhedralOp = index(comp, "GM_PolyhedralOp") > 0;
    ...
    END \
    {
      ...
      treat_comp(with_SPAOperators,      add_SPAOperators,      "GMModelCmpInterfaces");
      ...
      else
      {
        ...
        for (cnt1 = 1; cnt1 <= nb_fields; cnt1++)
        {
          ...
          if (fw == "")
          {
            ...
            if (mod != "")
            {
              ...
              if (! with_SPAOperators)
                with_SPAOperators = mod == "CATGMModelCmpInterfaces";
        ...
        else
        {
          ...
          if (in_LINK_WITH)
          {
            ...
            if (add_SPAOperators && ! with_SPAOperators)
            {
              itf_mod = itf_mod sep "CATGMModelCmpInterfaces";
              sep = " ";
            }
          }
