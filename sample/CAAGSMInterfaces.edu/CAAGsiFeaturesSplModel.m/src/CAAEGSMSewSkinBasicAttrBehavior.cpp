...
TIE_CATIGeomExtendAttrBehavior(CAAEGSMSewSkinBasicAttrBehavior);
...
//------------------------------------------------------------------------
HRESULT CAAEGSMSewSkinBasicAttrBehavior::GetRequestedBehavior(const CATUnicodeString* ipAttrId, CATListBehaviorSpecs& oBehaviorList)
{
