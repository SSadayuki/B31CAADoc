/**
* @quickreview VD6 19:09:20 IR-516722 CastToCharPtr() was depricated from CXR25, now using ConvertToChar API.
* @fullreview
**/
...
int main (int argc, char **argv)
{
  ...
  CATCatch (CATError, error)
    ...
    cout << "error message : "
         ...
         << endl;  // IR-516722 Fix : CastToCharPtr() was depricated from CXR25, hence now using ConvertToChar API.
    delete error;
    rc = 999;
	}	
  CATEndTry;
